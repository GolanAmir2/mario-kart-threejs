...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pr,depthTest:!1,depthWrite:!1})}function Ks(){return new Dr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ua(),fragmentShader:`
		...
		`,blending:pr,depthTest:!1,depthWrite:!1})}function Js(){return new Dr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ua(),fragmentShader:`
		...
		`,blending:pr,depthTest:!1,depthWrite:!1})}function Ua(){return`
...
}`;function mf(i,e,t){let r=new Da;const n=new he,a=new he,o=new ct,s=new hf({depthPacking:cc}),l=new df,c={},u=t.maxTextureSize,h={[gr]:At,[At]:gr,[ir]:ir},p=new Dr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new he},radius:{value:4}},vertexShader:pf,fragmentShader:ff}),f=p.clone();f.defines.HORIZONTAL_PASS=1;const g=new Dt;g.setAttribute("position",new jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Ge(g,p),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=To;let d=this.type;this.render=function(w,A,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;const V=i.getRenderTarget(),y=i.getActiveCubeFace(),b=i.getActiveMipmapLevel(),G=i.state;G.setBlending(pr),G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const H=d!==rr&&this.type===rr,q=d===rr&&this.type!==rr;for(let P=0,z=w.length;P<z;P++){const X=w[P],W=X.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",X,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;n.copy(W.mapSize);const ee=W.getFrameExtents();if(n.multiply(ee),a.copy(W.mapSize),(n.x>u||n.y>u)&&(n.x>u&&(a.x=Math.floor(u/ee.x),n.x=a.x*ee.x,W.mapSize.x=a.x),n.y>u&&(a.y=Math.floor(u/ee.y),n.y=a.y*ee.y,W.mapSize.y=a.y)),W.map===null||H===!0||q===!0){const K=this.type!==rr?{minFilter:Et,magFilter:Et}:{};W.map!==null&&W.map.dispose(),W.map=new Lr(n.x,n.y,K),W.map.texture.name=X.name+".shadowMap",W.camera.updateProjectionMatrix()}i.setRenderTarget(W.map),i.clear();const j=W.getViewportCount();for(let K=0;K<j;K++){const Q=W.getViewport(K);o.set(a.x*Q.x,a.y*Q.y,a.x*Q.z,a.y*Q.w),G.viewport(o),W.updateMatrices(X,K),r=W.getFrustum(),T(A,L,W.camera,X,this.type)}W.isPointLightShadow!==!0&&this.type===rr&&E(W,L),W.needsUpdate=!1}d=this.type,m.needsUpdate=!1,i.setRenderTarget(V,y,b)};function E(w,A){const L=e.update(_);p.defines.VSM_SAMPLES!==w.blurSamples&&(p.defines.VSM_SAMPLES=w.blurSamples,f.defines.VSM_SAMPLES=w.blurSamples,p.needsUpdate=!0,f.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Lr(n.x,n.y)),p.uniforms.shadow_pass.value=w.map.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(A,null,L,p,_,null),f.uniforms.shadow_pass.value=w.mapPass.texture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(A,null,L,f,_,null)}function v(w,A,L,V){let y=null;const b=L.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(b!==void 0)y=b;else if(y=L.isPointLight===!0?l:s,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const G=y.uuid,H=A.uuid;let q=c[G];q===void 0&&(q={},c[G]=q);let P=q[H];P===void 0&&(P=y.clone(),q[H]=P),y=P}if(y.visible=A.visible,y.wireframe=A.wireframe,V===rr?y.side=A.shadowSide!==null?A.shadowSide:A.side:y.side=A.shadowSide!==null?A.shadowSide:h[A.side],y.alphaMap=A.alphaMap,y.alphaTest=A.alphaTest,y.map=A.map,y.clipShadows=A.clipShadows,y.clippingPlanes=A.clippingPlanes,y.clipIntersection=A.clipIntersection,y.displacementMap=A.displacementMap,y.displacementScale=A.displacementScale,y.displacementBias=A.displacementBias,y.wireframeLinewidth=A.wireframeLinewidth,y.linewidth=A.linewidth,L.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const G=i.properties.get(y);G.light=L}return y}function T(w,A,L,V,y){if(w.visible===!1)return;if(w.layers.test(A.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&y===rr)&&(!w.frustumCulled||r.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,w.matrixWorld);const G=e.update(w),H=w.material;if(Array.isArray(H)){const q=G.groups;for(let P=0,z=q.length;P<z;P++){const X=q[P],W=H[X.materialIndex];if(W&&W.visible){const ee=v(w,W,V,y);w.onBeforeShadow(i,w,A,L,G,ee,X),i.renderBufferDirect(L,null,G,ee,w,X),w.onAfterShadow(i,w,A,L,G,ee,X)}}}else if(H.visible){const q=v(w,H,V,y);w.onBeforeShadow(i,w,A,L,G,q,null),i.renderBufferDirect(L,null,G,q,w,null),w.onAfterShadow(i,w,A,L,G,q,null)}}const b=w.children;for(let G=0,H=b.length;G<H;G++)T(b[G],A,L,V,y)}}function gf(i,e,t){const r=t.isWebGL2;function n(){let R=!1;const le=new ct;let J=null;const k=new ct(0,0,0,0);return{setMask:function(ie){J!==ie&&!R&&(i.colorMask(ie,ie,ie,ie),J=ie)},setLocked:function(ie){R=ie},setClear:function(ie,me,qe,rt,Ut){Ut===!0&&(ie*=rt,me*=rt,qe*=rt),le.set(ie,me,qe,rt),k.equals(le)===!1&&(i.clearColor(ie,me,qe,rt),k.copy(le))},reset:function(){R=!1,J=null,k.set(-1,0,0,0)}}}function a(){let R=!1,le=null,J=null,k=null;return{setTest:function(ie){ie?we(i.DEPTH_TEST):Te(i.DEPTH_TEST)},setMask:function(ie){le!==ie&&!R&&(i.depthMask(ie),le=ie)},setFunc:function(ie){if(J!==ie){switch(ie){case zl:i.depthFunc(i.NEVER);break;case Hl:i.depthFunc(i.ALWAYS);break;case Gl:i.depthFunc(i.LESS);break;case cn:i.depthFunc(i.LEQUAL);break;case Vl:i.depthFunc(i.EQUAL);break;case kl:i.depthFunc(i.GEQUAL);break;case Wl:i.depthFunc(i.GREATER);break;case Xl:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}J=ie}},setLocked:function(ie){R=ie},setClear:function(ie){k!==ie&&(i.clearDepth(ie),k=ie)},reset:function(){R=!1,le=null,J=null,k=null}}}function o(){let R=!1,le=null,J=null,k=null,ie=null,me=null,qe=null,rt=null,Ut=null;return{setTest:function(Ye){R||(Ye?we(i.STENCIL_TEST):Te(i.STENCIL_TEST))},setMask:function(Ye){le!==Ye&&!R&&(i.stencilMask(Ye),le=Ye)},setFunc:function(Ye,Mt,qt){(J!==Ye||k!==Mt||ie!==qt)&&(i.stencilFunc(Ye,Mt,qt),J=Ye,k=Mt,ie=qt)},setOp:function(Ye,Mt,qt){(me!==Ye||qe!==Mt||rt!==qt)&&(i.stencilOp(Ye,Mt,qt),me=Ye,qe=Mt,rt=qt)},setLocked:function(Ye){R=Ye},setClear:function(Ye){Ut!==Ye&&(i.clearStencil(Ye),Ut=Ye)},reset:function(){R=!1,le=null,J=null,k=null,ie=null,me=null,qe=null,rt=null,Ut=null}}}const s=new n,l=new a,c=new o,u=new WeakMap,h=new WeakMap;let p={},f={},g=new WeakMap,_=[],m=null,d=!1,E=null,v=null,T=null,w=null,A=null,L=null,V=null,y=new Ve(0,0,0),b=0,G=!1,H=null,q=null,P=null,z=null,X=null;const W=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ee=!1,j=0;const K=i.getParameter(i.VERSION);K.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(K)[1]),ee=j>=1):K.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),ee=j>=2);let Q=null,ue={};const B=i.getParameter(i.SCISSOR_BOX),Y=i.getParameter(i.VIEWPORT),de=new ct().fromArray(B),fe=new ct().fromArray(Y);function ge(R,le,J,k){const ie=new Uint8Array(4),me=i.createTexture();i.bindTexture(R,me),i.texParameteri(R,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(R,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let qe=0;qe<J;qe++)r&&(R===i.TEXTURE_3D||R===i.TEXTURE_2D_ARRAY)?i.texImage3D(le,0,i.RGBA,1,1,k,0,i.RGBA,i.UNSIGNED_BYTE,ie):i.texImage2D(le+qe,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ie);return me}const Ce={};Ce[i.TEXTURE_2D]=ge(i.TEXTURE_2D,i.TEXTURE_2D,1),Ce[i.TEXTURE_CUBE_MAP]=ge(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),r&&(Ce[i.TEXTURE_2D_ARRAY]=ge(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Ce[i.TEXTURE_3D]=ge(i.TEXTURE_3D,i.TEXTURE_3D,1,1)),s.setClear(0,0,0,1),l.setClear(1),c.setClear(0),we(i.DEPTH_TEST),l.setFunc(cn),Ne(!1),Re(ja),we(i.CULL_FACE),Se(pr);function we(R){p[R]!==!0&&(i.enable(R),p[R]=!0)}function Te(R){p[R]!==!1&&(i.disable(R),p[R]=!1)}function Le(R,le){return f[R]!==le?(i.bindFramebuffer(R,le),f[R]=le,r&&(R===i.DRAW_FRAMEBUFFER&&(f[i.FRAMEBUFFER]=le),R===i.FRAMEBUFFER&&(f[i.DRAW_FRAMEBUFFER]=le)),!0):!1}function I(R,le){let J=_,k=!1;if(R)if(J=g.get(le),J===void 0&&(J=[],g.set(le,J)),R.isWebGLMultipleRenderTargets){const ie=R.texture;if(J.length!==ie.length||J[0]!==i.COLOR_ATTACHMENT0){for(let me=0,qe=ie.length;me<qe;me++)J[me]=i.COLOR_ATTACHMENT0+me;J.length=ie.length,k=!0}}else J[0]!==i.COLOR_ATTACHMENT0&&(J[0]=i.COLOR_ATTACHMENT0,k=!0);else J[0]!==i.BACK&&(J[0]=i.BACK,k=!0);k&&(t.isWebGL2?i.drawBuffers(J):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(J))}function yt(R){return m!==R?(i.useProgram(R),m=R,!0):!1}const ve={[wr]:i.FUNC_ADD,[Tl]:i.FUNC_SUBTRACT,[bl]:i.FUNC_REVERSE_SUBTRACT};if(r)ve[Ja]=i.MIN,ve[Za]=i.MAX;else{const R=e.get("EXT_blend_minmax");R!==null&&(ve[Ja]=R.MIN_EXT,ve[Za]=R.MAX_EXT)}const Fe={[wl]:i.ZERO,[Al]:i.ONE,[Rl]:i.SRC_COLOR,[ca]:i.SRC_ALPHA,[Nl]:i.SRC_ALPHA_SATURATE,[Dl]:i.DST_COLOR,[Pl]:i.DST_ALPHA,[Cl]:i.ONE_MINUS_SRC_COLOR,[ua]:i.ONE_MINUS_SRC_ALPHA,[Ul]:i.ONE_MINUS_DST_COLOR,[Ll]:i.ONE_MINUS_DST_ALPHA,[Il]:i.CONSTANT_COLOR,[Ol]:i.ONE_MINUS_CONSTANT_COLOR,[Fl]:i.CONSTANT_ALPHA,[Bl]:i.ONE_MINUS_CONSTANT_ALPHA};function Se(R,le,J,k,ie,me,qe,rt,Ut,Ye){if(R===pr){d===!0&&(Te(i.BLEND),d=!1);return}if(d===!1&&(we(i.BLEND),d=!0),R!==El){if(R!==E||Ye!==G){if((v!==wr||A!==wr)&&(i.blendEquation(i.FUNC_ADD),v=wr,A=wr),Ye)switch(R){case $r:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case qa:i.blendFunc(i.ONE,i.ONE);break;case Ya:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ka:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}else switch(R){case $r:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case qa:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Ya:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ka:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}T=null,w=null,L=null,V=null,y.set(0,0,0),b=0,E=R,G=Ye}return}ie=ie||le,me=me||J,qe=qe||k,(le!==v||ie!==A)&&(i.blendEquationSeparate(ve[le],ve[ie]),v=le,A=ie),(J!==T||k!==w||me!==L||qe!==V)&&(i.blendFuncSeparate(Fe[J],Fe[k],Fe[me],Fe[qe]),T=J,w=k,L=me,V=qe),(rt.equals(y)===!1||Ut!==b)&&(i.blendColor(rt.r,rt.g,rt.b,Ut),y.copy(rt),b=Ut),E=R,G=!1}function Ze(R,le){R.side===ir?Te(i.CULL_FACE):we(i.CULL_FACE);let J=R.side===At;le&&(J=!J),Ne(J),R.blending===$r&&R.transparent===!1?Se(pr):Se(R.blending,R.blendEquation,R.blendSrc,R.blendDst,R.blendEquationAlpha,R.blendSrcAlpha,R.blendDstAlpha,R.blendColor,R.blendAlpha,R.premultipliedAlpha),l.setFunc(R.depthFunc),l.setTest(R.depthTest),l.setMask(R.depthWrite),s.setMask(R.colorWrite);const k=R.stencilWrite;c.setTest(k),k&&(c.setMask(R.stencilWriteMask),c.setFunc(R.stencilFunc,R.stencilRef,R.stencilFuncMask),c.setOp(R.stencilFail,R.stencilZFail,R.stencilZPass)),ut(R.polygonOffset,R.polygonOffsetFactor,R.polygonOffsetUnits),R.alphaToCoverage===!0?we(i.SAMPLE_ALPHA_TO_COVERAGE):Te(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ne(R){H!==R&&(R?i.frontFace(i.CW):i.frontFace(i.CCW),H=R)}function Re(R){R!==Ml?(we(i.CULL_FACE),R!==q&&(R===ja?i.cullFace(i.BACK):R===Sl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Te(i.CULL_FACE),q=R}function We(R){R!==P&&(ee&&i.lineWidth(R),P=R)}function ut(R,le,J){R?(we(i.POLYGON_OFFSET_FILL),(z!==le||X!==J)&&(i.polygonOffset(le,J),z=le,X=J)):Te(i.POLYGON_OFFSET_FILL)}function ht(R){R?we(i.SCISSOR_TEST):Te(i.SCISSOR_TEST)}function S(R){R===void 0&&(R=i.TEXTURE0+W-1),Q!==R&&(i.activeTexture(R),Q=R)}function x(R,le,J){J===void 0&&(Q===null?J=i.TEXTURE0+W-1:J=Q);let k=ue[J];k===void 0&&(k={type:void 0,texture:void 0},ue[J]=k),(k.type!==R||k.texture!==le)&&(Q!==J&&(i.activeTexture(J),Q=J),i.bindTexture(R,le||Ce[R]),k.type=R,k.texture=le)}function U(){const R=ue[Q];R!==void 0&&R.type!==void 0&&(i.bindTexture(R.type,null),R.type=void 0,R.texture=void 0)}function te(){try{i.compressedTexImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Z(){try{i.compressedTexImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function $(){try{i.texSubImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function pe(){try{i.texSubImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function ne(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function oe(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Me(){try{i.texStorage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function ke(){try{i.texStorage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function re(){try{i.texImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Xe(){try{i.texImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Ae(R){de.equals(R)===!1&&(i.scissor(R.x,R.y,R.z,R.w),de.copy(R))}function Ee(R){fe.equals(R)===!1&&(i.viewport(R.x,R.y,R.z,R.w),fe.copy(R))}function xe(R,le){let J=h.get(le);J===void 0&&(J=new WeakMap,h.set(le,J));let k=J.get(R);k===void 0&&(k=i.getUniformBlockIndex(le,R.name),J.set(R,k))}function ce(R,le){const J=h.get(le).get(R);u.get(le)!==J&&(i.uniformBlockBinding(le,J,R.__bindingPointIndex),u.set(le,J))}function Be(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),r===!0&&(i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null)),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),p={},Q=null,ue={},f={},g=new WeakMap,_=[],m=null,d=!1,E=null,v=null,T=null,w=null,A=null,L=null,V=null,y=new Ve(0,0,0),b=0,G=!1,H=null,q=null,P=null,z=null,X=null,de.set(0,0,i.canvas.width,i.canvas.height),fe.set(0,0,i.canvas.width,i.canvas.height),s.reset(),l.reset(),c.reset()}return{buffers:{color:s,depth:l,stencil:c},enable:we,disable:Te,bindFramebuffer:Le,drawBuffers:I,useProgram:yt,setBlending:Se,setMaterial:Ze,setFlipSided:Ne,setCullFace:Re,setLineWidth:We,setPolygonOffset:ut,setScissorTest:ht,activeTexture:S,bindTexture:x,unbindTexture:U,compressedTexImage2D:te,compressedTexImage3D:Z,texImage2D:re,texImage3D:Xe,updateUBOMapping:xe,uniformBlockBinding:ce,texStorage2D:Me,texStorage3D:ke,texSubImage2D:$,texSubImage3D:pe,compressedTexSubImage2D:ne,compressedTexSubImage3D:oe,scissor:Ae,viewport:Ee,reset:Be}}function _f(i,e,t,r,n,a,o){const s=n.isWebGL2,l=n.maxTextures,c=n.maxCubemapSize,u=n.maxTextureSize,h=n.maxSamples,p=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,f=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),g=new WeakMap;let _;const m=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(S,x){return d?new OffscreenCanvas(S,x):fn("canvas")}function v(S,x,U,te){let Z=1;if((S.width>te||S.height>te)&&(Z=te/Math.max(S.width,S.height)),Z<1||x===!0)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap){const $=x?_a:Math.floor,pe=$(Z*S.width),ne=$(Z*S.height);_===void 0&&(_=E(pe,ne));const oe=U?E(pe,ne):_;return oe.width=pe,oe.height=ne,oe.getContext("2d").drawImage(S,0,0,pe,ne),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+S.width+"x"+S.height+") to ("+pe+"x"+ne+")."),oe}else return"data"in S&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+S.width+"x"+S.height+")."),S;return S}function T(S){return As(S.width)&&As(S.height)}function w(S){return s?!1:S.wrapS!==Wt||S.wrapT!==Wt||S.minFilter!==Et&&S.minFilter!==Ft}function A(S,x){return S.generateMipmaps&&x&&S.minFilter!==Et&&S.minFilter!==Ft}function L(S){i.generateMipmap(S)}function V(S,x,U,te,Z=!1){if(s===!1)return x;if(S!==null){if(i[S]!==void 0)return i[S];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let $=x;if(x===i.RED&&(U===i.FLOAT&&($=i.R32F),U===i.HALF_FLOAT&&($=i.R16F),U===i.UNSIGNED_BYTE&&($=i.R8)),x===i.RED_INTEGER&&(U===i.UNSIGNED_BYTE&&($=i.R8UI),U===i.UNSIGNED_SHORT&&($=i.R16UI),U===i.UNSIGNED_INT&&($=i.R32UI),U===i.BYTE&&($=i.R8I),U===i.SHORT&&($=i.R16I),U===i.INT&&($=i.R32I)),x===i.RG&&(U===i.FLOAT&&($=i.RG32F),U===i.HALF_FLOAT&&($=i.RG16F),U===i.UNSIGNED_BYTE&&($=i.RG8)),x===i.RGBA){const pe=Z?un:je.getTransfer(te);U===i.FLOAT&&($=i.RGBA32F),U===i.HALF_FLOAT&&($=i.RGBA16F),U===i.UNSIGNED_BYTE&&($=pe===Je?i.SRGB8_ALPHA8:i.RGBA8),U===i.UNSIGNED_SHORT_4_4_4_4&&($=i.RGBA4),U===i.UNSIGNED_SHORT_5_5_5_1&&($=i.RGB5_A1)}return($===i.R16F||$===i.R32F||$===i.RG16F||$===i.RG32F||$===i.RGBA16F||$===i.RGBA32F)&&e.get("EXT_color_buffer_float"),$}function y(S,x,U){return A(S,U)===!0||S.isFramebufferTexture&&S.minFilter!==Et&&S.minFilter!==Ft?Math.log2(Math.max(x.width,x.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?x.mipmaps.length:1}function b(S){return S===Et||S===Qa||S===Rn?i.NEAREST:i.LINEAR}function G(S){const x=S.target;x.removeEventListener("dispose",G),q(x),x.isVideoTexture&&g.delete(x)}function H(S){const x=S.target;x.removeEventListener("dispose",H),z(x)}function q(S){const x=r.get(S);if(x.__webglInit===void 0)return;const U=S.source,te=m.get(U);if(te){const Z=te[x.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&P(S),Object.keys(te).length===0&&m.delete(U)}r.remove(S)}function P(S){const x=r.get(S);i.deleteTexture(x.__webglTexture);const U=S.source,te=m.get(U);delete te[x.__cacheKey],o.memory.textures--}function z(S){const x=S.texture,U=r.get(S),te=r.get(x);if(te.__webglTexture!==void 0&&(i.deleteTexture(te.__webglTexture),o.memory.textures--),S.depthTexture&&S.depthTexture.dispose(),S.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(U.__webglFramebuffer[Z]))for(let $=0;$<U.__webglFramebuffer[Z].length;$++)i.deleteFramebuffer(U.__webglFramebuffer[Z][$]);else i.deleteFramebuffer(U.__webglFramebuffer[Z]);U.__webglDepthbuffer&&i.deleteRenderbuffer(U.__webglDepthbuffer[Z])}else{if(Array.isArray(U.__webglFramebuffer))for(let Z=0;Z<U.__webglFramebuffer.length;Z++)i.deleteFramebuffer(U.__webglFramebuffer[Z]);else i.deleteFramebuffer(U.__webglFramebuffer);if(U.__webglDepthbuffer&&i.deleteRenderbuffer(U.__webglDepthbuffer),U.__webglMultisampledFramebuffer&&i.deleteFramebuffer(U.__webglMultisampledFramebuffer),U.__webglColorRenderbuffer)for(let Z=0;Z<U.__webglColorRenderbuffer.length;Z++)U.__webglColorRenderbuffer[Z]&&i.deleteRenderbuffer(U.__webglColorRenderbuffer[Z]);U.__webglDepthRenderbuffer&&i.deleteRenderbuffer(U.__webglDepthRenderbuffer)}if(S.isWebGLMultipleRenderTargets)for(let Z=0,$=x.length;Z<$;Z++){const pe=r.get(x[Z]);pe.__webglTexture&&(i.deleteTexture(pe.__webglTexture),o.memory.textures--),r.remove(x[Z])}r.remove(x),r.remove(S)}let X=0;function W(){X=0}function ee(){const S=X;return S>=l&&console.warn("THREE.WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+l),X+=1,S}function j(S){const x=[];return x.push(S.wrapS),x.push(S.wrapT),x.push(S.wrapR||0),x.push(S.magFilter),x.push(S.minFilter),x.push(S.anisotropy),x.push(S.internalFormat),x.push(S.format),x.push(S.type),x.push(S.generateMipmaps),x.push(S.premultiplyAlpha),x.push(S.flipY),x.push(S.unpackAlignment),x.push(S.colorSpace),x.join()}function K(S,x){const U=r.get(S);if(S.isVideoTexture&&ut(S),S.isRenderTargetTexture===!1&&S.version>0&&U.__version!==S.version){const te=S.image;if(te===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(te.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{we(U,S,x);return}}t.bindTexture(i.TEXTURE_2D,U.__webglTexture,i.TEXTURE0+x)}function Q(S,x){const U=r.get(S);if(S.version>0&&U.__version!==S.version){we(U,S,x);return}t.bindTexture(i.TEXTURE_2D_ARRAY,U.__webglTexture,i.TEXTURE0+x)}function ue(S,x){const U=r.get(S);if(S.version>0&&U.__version!==S.version){we(U,S,x);return}t.bindTexture(i.TEXTURE_3D,U.__webglTexture,i.TEXTURE0+x)}function B(S,x){const U=r.get(S);if(S.version>0&&U.__version!==S.version){Te(U,S,x);return}t.bindTexture(i.TEXTURE_CUBE_MAP,U.__webglTexture,i.TEXTURE0+x)}const Y={[pa]:i.REPEAT,[Wt]:i.CLAMP_TO_EDGE,[fa]:i.MIRRORED_REPEAT},de={[Et]:i.NEAREST,[Qa]:i.NEAREST_MIPMAP_NEAREST,[Rn]:i.NEAREST_MIPMAP_LINEAR,[Ft]:i.LINEAR,[$l]:i.LINEAR_MIPMAP_NEAREST,[Ti]:i.LINEAR_MIPMAP_LINEAR},fe={[hc]:i.NEVER,[_c]:i.ALWAYS,[dc]:i.LESS,[Fo]:i.LEQUAL,[pc]:i.EQUAL,[gc]:i.GEQUAL,[fc]:i.GREATER,[mc]:i.NOTEQUAL};function ge(S,x,U){if(U?(i.texParameteri(S,i.TEXTURE_WRAP_S,Y[x.wrapS]),i.texParameteri(S,i.TEXTURE_WRAP_T,Y[x.wrapT]),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,Y[x.wrapR]),i.texParameteri(S,i.TEXTURE_MAG_FILTER,de[x.magFilter]),i.texParameteri(S,i.TEXTURE_MIN_FILTER,de[x.minFilter])):(i.texParameteri(S,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(S,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,i.CLAMP_TO_EDGE),(x.wrapS!==Wt||x.wrapT!==Wt)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),i.texParameteri(S,i.TEXTURE_MAG_FILTER,b(x.magFilter)),i.texParameteri(S,i.TEXTURE_MIN_FILTER,b(x.minFilter)),x.minFilter!==Et&&x.minFilter!==Ft&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),x.compareFunction&&(i.texParameteri(S,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(S,i.TEXTURE_COMPARE_FUNC,fe[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const te=e.get("EXT_texture_filter_anisotropic");if(x.magFilter===Et||x.minFilter!==Rn&&x.minFilter!==Ti||x.type===dr&&e.has("OES_texture_float_linear")===!1||s===!1&&x.type===bi&&e.has("OES_texture_half_float_linear")===!1)return;(x.anisotropy>1||r.get(x).__currentAnisotropy)&&(i.texParameterf(S,te.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,n.getMaxAnisotropy())),r.get(x).__currentAnisotropy=x.anisotropy)}}function Ce(S,x){let U=!1;S.__webglInit===void 0&&(S.__webglInit=!0,x.addEventListener("dispose",G));const te=x.source;let Z=m.get(te);Z===void 0&&(Z={},m.set(te,Z));const $=j(x);if($!==S.__cacheKey){Z[$]===void 0&&(Z[$]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,U=!0),Z[$].usedTimes++;const pe=Z[S.__cacheKey];pe!==void 0&&(Z[S.__cacheKey].usedTimes--,pe.usedTimes===0&&P(x)),S.__cacheKey=$,S.__webglTexture=Z[$].texture}return U}function we(S,x,U){let te=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(te=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(te=i.TEXTURE_3D);const Z=Ce(S,x),$=x.source;t.bindTexture(te,S.__webglTexture,i.TEXTURE0+U);const pe=r.get($);if($.version!==pe.__version||Z===!0){t.activeTexture(i.TEXTURE0+U);const ne=je.getPrimaries(je.workingColorSpace),oe=x.colorSpace===zt?null:je.getPrimaries(x.colorSpace),Me=x.colorSpace===zt||ne===oe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Me);const ke=w(x)&&T(x.image)===!1;let re=v(x.image,ke,!1,u);re=ht(x,re);const Xe=T(re)||s,Ae=a.convert(x.format,x.colorSpace);let Ee=a.convert(x.type),xe=V(x.internalFormat,Ae,Ee,x.colorSpace,x.isVideoTexture);ge(te,x,Xe);let ce;const Be=x.mipmaps,R=s&&x.isVideoTexture!==!0&&xe!==No,le=pe.__version===void 0||Z===!0,J=y(x,re,Xe);if(x.isDepthTexture)xe=i.DEPTH_COMPONENT,s?x.type===dr?xe=i.DEPTH_COMPONENT32F:x.type===hr?xe=i.DEPTH_COMPONENT24:x.type===Rr?xe=i.DEPTH24_STENCIL8:xe=i.DEPTH_COMPONENT16:x.type===dr&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),x.format===Cr&&xe===i.DEPTH_COMPONENT&&x.type!==Aa&&x.type!==hr&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),x.type=hr,Ee=a.convert(x.type)),x.format===ni&&xe===i.DEPTH_COMPONENT&&(xe=i.DEPTH_STENCIL,x.type!==Rr&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),x.type=Rr,Ee=a.convert(x.type))),le&&(R?t.texStorage2D(i.TEXTURE_2D,1,xe,re.width,re.height):t.texImage2D(i.TEXTURE_2D,0,xe,re.width,re.height,0,Ae,Ee,null));else if(x.isDataTexture)if(Be.length>0&&Xe){R&&le&&t.texStorage2D(i.TEXTURE_2D,J,xe,Be[0].width,Be[0].height);for(let k=0,ie=Be.length;k<ie;k++)ce=Be[k],R?t.texSubImage2D(i.TEXTURE_2D,k,0,0,ce.width,ce.height,Ae,Ee,ce.data):t.texImage2D(i.TEXTURE_2D,k,xe,ce.width,ce.height,0,Ae,Ee,ce.data);x.generateMipmaps=!1}else R?(le&&t.texStorage2D(i.TEXTURE_2D,J,xe,re.width,re.height),t.texSubImage2D(i.TEXTURE_2D,0,0,0,re.width,re.height,Ae,Ee,re.data)):t.texImage2D(i.TEXTURE_2D,0,xe,re.width,re.height,0,Ae,Ee,re.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){R&&le&&t.texStorage3D(i.TEXTURE_2D_ARRAY,J,xe,Be[0].width,Be[0].height,re.depth);for(let k=0,ie=Be.length;k<ie;k++)ce=Be[k],x.format!==Xt?Ae!==null?R?t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,k,0,0,0,ce.width,ce.height,re.depth,Ae,ce.data,0,0):t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,k,xe,ce.width,ce.height,re.depth,0,ce.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):R?t.texSubImage3D(i.TEXTURE_2D_ARRAY,k,0,0,0,ce.width,ce.height,re.depth,Ae,Ee,ce.data):t.texImage3D(i.TEXTURE_2D_ARRAY,k,xe,ce.width,ce.height,re.depth,0,Ae,Ee,ce.data)}else{R&&le&&t.texStorage2D(i.TEXTURE_2D,J,xe,Be[0].width,Be[0].height);for(let k=0,ie=Be.length;k<ie;k++)ce=Be[k],x.format!==Xt?Ae!==null?R?t.compressedTexSubImage2D(i.TEXTURE_2D,k,0,0,ce.width,ce.height,Ae,ce.data):t.compressedTexImage2D(i.TEXTURE_2D,k,xe,ce.width,ce.height,0,ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):R?t.texSubImage2D(i.TEXTURE_2D,k,0,0,ce.width,ce.height,Ae,Ee,ce.data):t.texImage2D(i.TEXTURE_2D,k,xe,ce.width,ce.height,0,Ae,Ee,ce.data)}else if(x.isDataArrayTexture)R?(le&&t.texStorage3D(i.TEXTURE_2D_ARRAY,J,xe,re.width,re.height,re.depth),t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,re.width,re.height,re.depth,Ae,Ee,re.data)):t.texImage3D(i.TEXTURE_2D_ARRAY,0,xe,re.width,re.height,re.depth,0,Ae,Ee,re.data);else if(x.isData3DTexture)R?(le&&t.texStorage3D(i.TEXTURE_3D,J,xe,re.width,re.height,re.depth),t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,re.width,re.height,re.depth,Ae,Ee,re.data)):t.texImage3D(i.TEXTURE_3D,0,xe,re.width,re.height,re.depth,0,Ae,Ee,re.data);else if(x.isFramebufferTexture){if(le)if(R)t.texStorage2D(i.TEXTURE_2D,J,xe,re.width,re.height);else{let k=re.width,ie=re.height;for(let me=0;me<J;me++)t.texImage2D(i.TEXTURE_2D,me,xe,k,ie,0,Ae,Ee,null),k>>=1,ie>>=1}}else if(Be.length>0&&Xe){R&&le&&t.texStorage2D(i.TEXTURE_2D,J,xe,Be[0].width,Be[0].height);for(let k=0,ie=Be.length;k<ie;k++)ce=Be[k],R?t.texSubImage2D(i.TEXTURE_2D,k,0,0,Ae,Ee,ce):t.texImage2D(i.TEXTURE_2D,k,xe,Ae,Ee,ce);x.generateMipmaps=!1}else R?(le&&t.texStorage2D(i.TEXTURE_2D,J,xe,re.width,re.height),t.texSubImage2D(i.TEXTURE_2D,0,0,0,Ae,Ee,re)):t.texImage2D(i.TEXTURE_2D,0,xe,Ae,Ee,re);A(x,Xe)&&L(te),pe.__version=$.version,x.onUpdate&&x.onUpdate(x)}S.__version=x.version}function Te(S,x,U){if(x.image.length!==6)return;const te=Ce(S,x),Z=x.source;t.bindTexture(i.TEXTURE_CUBE_MAP,S.__webglTexture,i.TEXTURE0+U);const $=r.get(Z);if(Z.version!==$.__version||te===!0){t.activeTexture(i.TEXTURE0+U);const pe=je.getPrimaries(je.workingColorSpace),ne=x.colorSpace===zt?null:je.getPrimaries(x.colorSpace),oe=x.colorSpace===zt||pe===ne?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,oe);const Me=x.isCompressedTexture||x.image[0].isCompressedTexture,ke=x.image[0]&&x.image[0].isDataTexture,re=[];for(let k=0;k<6;k++)!Me&&!ke?re[k]=v(x.image[k],!1,!0,c):re[k]=ke?x.image[k].image:x.image[k],re[k]=ht(x,re[k]);const Xe=re[0],Ae=T(Xe)||s,Ee=a.convert(x.format,x.colorSpace),xe=a.convert(x.type),ce=V(x.internalFormat,Ee,xe,x.colorSpace),Be=s&&x.isVideoTexture!==!0,R=$.__version===void 0||te===!0;let le=y(x,Xe,Ae);ge(i.TEXTURE_CUBE_MAP,x,Ae);let J;if(Me){Be&&R&&t.texStorage2D(i.TEXTURE_CUBE_MAP,le,ce,Xe.width,Xe.height);for(let k=0;k<6;k++){J=re[k].mipmaps;for(let ie=0;ie<J.length;ie++){const me=J[ie];x.format!==Xt?Ee!==null?Be?t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+k,ie,0,0,me.width,me.height,Ee,me.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+k,ie,ce,me.width,me.height,0,me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Be?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+k,ie,0,0,me.width,me.height,Ee,xe,me.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+k,ie,ce,me.width,me.height,0,Ee,xe,me.data)}}}else{J=x.mipmaps,Be&&R&&(J.length>0&&le++,t.texStorage2D(i.TEXTURE_CUBE_MAP,le,ce,re[0].width,re[0].height));for(let k=0;k<6;k++)if(ke){Be?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+k,0,0,0,re[k].width,re[k].height,Ee,xe,re[k].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+k,0,ce,re[k].width,re[k].height,0,Ee,xe,re[k].data);for(let ie=0;ie<J.length;ie++){const me=J[ie].image[k].image;Be?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+k,ie+1,0,0,me.width,me.height,Ee,xe,me.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+k,ie+1,ce,me.width,me.height,0,Ee,xe,me.data)}}else{Be?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+k,0,0,0,Ee,xe,re[k]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+k,0,ce,Ee,xe,re[k]);for(let ie=0;ie<J.length;ie++){const me=J[ie];Be?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+k,ie+1,0,0,Ee,xe,me.image[k]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+k,ie+1,ce,Ee,xe,me.image[k])}}}A(x,Ae)&&L(i.TEXTURE_CUBE_MAP),$.__version=Z.version,x.onUpdate&&x.onUpdate(x)}S.__version=x.version}function Le(S,x,U,te,Z,$){const pe=a.convert(U.format,U.colorSpace),ne=a.convert(U.type),oe=V(U.internalFormat,pe,ne,U.colorSpace);if(!r.get(x).__hasExternalTextures){const Me=Math.max(1,x.width>>$),ke=Math.max(1,x.height>>$);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?t.texImage3D(Z,$,oe,Me,ke,x.depth,0,pe,ne,null):t.texImage2D(Z,$,oe,Me,ke,0,pe,ne,null)}t.bindFramebuffer(i.FRAMEBUFFER,S),We(x)?p.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,te,Z,r.get(U).__webglTexture,0,Re(x)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,te,Z,r.get(U).__webglTexture,$),t.bindFramebuffer(i.FRAMEBUFFER,null)}function I(S,x,U){if(i.bindRenderbuffer(i.RENDERBUFFER,S),x.depthBuffer&&!x.stencilBuffer){let te=s===!0?i.DEPTH_COMPONENT24:i.DEPTH_COMPONENT16;if(U||We(x)){const Z=x.depthTexture;Z&&Z.isDepthTexture&&(Z.type===dr?te=i.DEPTH_COMPONENT32F:Z.type===hr&&(te=i.DEPTH_COMPONENT24));const $=Re(x);We(x)?p.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,$,te,x.width,x.height):i.renderbufferStorageMultisample(i.RENDERBUFFER,$,te,x.width,x.height)}else i.renderbufferStorage(i.RENDERBUFFER,te,x.width,x.height);i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.RENDERBUFFER,S)}else if(x.depthBuffer&&x.stencilBuffer){const te=Re(x);U&&We(x)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,te,i.DEPTH24_STENCIL8,x.width,x.height):We(x)?p.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,te,i.DEPTH24_STENCIL8,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,i.DEPTH_STENCIL,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.RENDERBUFFER,S)}else{const te=x.isWebGLMultipleRenderTargets===!0?x.texture:[x.texture];for(let Z=0;Z<te.length;Z++){const $=te[Z],pe=a.convert($.format,$.colorSpace),ne=a.convert($.type),oe=V($.internalFormat,pe,ne,$.colorSpace),Me=Re(x);U&&We(x)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Me,oe,x.width,x.height):We(x)?p.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Me,oe,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,oe,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function yt(S,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,S),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!r.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),K(x.depthTexture,0);const U=r.get(x.depthTexture).__webglTexture,te=Re(x);if(x.depthTexture.format===Cr)We(x)?p.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,U,0,te):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,U,0);else if(x.depthTexture.format===ni)We(x)?p.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,U,0,te):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,U,0);else throw new Error("Unknown depthTexture format")}function ve(S){const x=r.get(S),U=S.isWebGLCubeRenderTarget===!0;if(S.depthTexture&&!x.__autoAllocateDepthBuffer){if(U)throw new Error("target.depthTexture not supported in Cube render targets");yt(x.__webglFramebuffer,S)}else if(U){x.__webglDepthbuffer=[];for(let te=0;te<6;te++)t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[te]),x.__webglDepthbuffer[te]=i.createRenderbuffer(),I(x.__webglDepthbuffer[te],S,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer=i.createRenderbuffer(),I(x.__webglDepthbuffer,S,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function Fe(S,x,U){const te=r.get(S);x!==void 0&&Le(te.__webglFramebuffer,S,S.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),U!==void 0&&ve(S)}function Se(S){const x=S.texture,U=r.get(S),te=r.get(x);S.addEventListener("dispose",H),S.isWebGLMultipleRenderTargets!==!0&&(te.__webglTexture===void 0&&(te.__webglTexture=i.createTexture()),te.__version=x.version,o.memory.textures++);const Z=S.isWebGLCubeRenderTarget===!0,$=S.isWebGLMultipleRenderTargets===!0,pe=T(S)||s;if(Z){U.__webglFramebuffer=[];for(let ne=0;ne<6;ne++)if(s&&x.mipmaps&&x.mipmaps.length>0){U.__webglFramebuffer[ne]=[];for(let oe=0;oe<x.mipmaps.length;oe++)U.__webglFramebuffer[ne][oe]=i.createFramebuffer()}else U.__webglFramebuffer[ne]=i.createFramebuffer()}else{if(s&&x.mipmaps&&x.mipmaps.length>0){U.__webglFramebuffer=[];for(let ne=0;ne<x.mipmaps.length;ne++)U.__webglFramebuffer[ne]=i.createFramebuffer()}else U.__webglFramebuffer=i.createFramebuffer();if($)if(n.drawBuffers){const ne=S.texture;for(let oe=0,Me=ne.length;oe<Me;oe++){const ke=r.get(ne[oe]);ke.__webglTexture===void 0&&(ke.__webglTexture=i.createTexture(),o.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(s&&S.samples>0&&We(S)===!1){const ne=$?x:[x];U.__webglMultisampledFramebuffer=i.createFramebuffer(),U.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let oe=0;oe<ne.length;oe++){const Me=ne[oe];U.__webglColorRenderbuffer[oe]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,U.__webglColorRenderbuffer[oe]);const ke=a.convert(Me.format,Me.colorSpace),re=a.convert(Me.type),Xe=V(Me.internalFormat,ke,re,Me.colorSpace,S.isXRRenderTarget===!0),Ae=Re(S);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ae,Xe,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+oe,i.RENDERBUFFER,U.__webglColorRenderbuffer[oe])}i.bindRenderbuffer(i.RENDERBUFFER,null),S.depthBuffer&&(U.__webglDepthRenderbuffer=i.createRenderbuffer(),I(U.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(Z){t.bindTexture(i.TEXTURE_CUBE_MAP,te.__webglTexture),ge(i.TEXTURE_CUBE_MAP,x,pe);for(let ne=0;ne<6;ne++)if(s&&x.mipmaps&&x.mipmaps.length>0)for(let oe=0;oe<x.mipmaps.length;oe++)Le(U.__webglFramebuffer[ne][oe],S,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,oe);else Le(U.__webglFramebuffer[ne],S,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0);A(x,pe)&&L(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if($){const ne=S.texture;for(let oe=0,Me=ne.length;oe<Me;oe++){const ke=ne[oe],re=r.get(ke);t.bindTexture(i.TEXTURE_2D,re.__webglTexture),ge(i.TEXTURE_2D,ke,pe),Le(U.__webglFramebuffer,S,ke,i.COLOR_ATTACHMENT0+oe,i.TEXTURE_2D,0),A(ke,pe)&&L(i.TEXTURE_2D)}t.unbindTexture()}else{let ne=i.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(s?ne=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(ne,te.__webglTexture),ge(ne,x,pe),s&&x.mipmaps&&x.mipmaps.length>0)for(let oe=0;oe<x.mipmaps.length;oe++)Le(U.__webglFramebuffer[oe],S,x,i.COLOR_ATTACHMENT0,ne,oe);else Le(U.__webglFramebuffer,S,x,i.COLOR_ATTACHMENT0,ne,0);A(x,pe)&&L(ne),t.unbindTexture()}S.depthBuffer&&ve(S)}function Ze(S){const x=T(S)||s,U=S.isWebGLMultipleRenderTargets===!0?S.texture:[S.texture];for(let te=0,Z=U.length;te<Z;te++){const $=U[te];if(A($,x)){const pe=S.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,ne=r.get($).__webglTexture;t.bindTexture(pe,ne),L(pe),t.unbindTexture()}}}function Ne(S){if(s&&S.samples>0&&We(S)===!1){const x=S.isWebGLMultipleRenderTargets?S.texture:[S.texture],U=S.width,te=S.height;let Z=i.COLOR_BUFFER_BIT;const $=[],pe=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=r.get(S),oe=S.isWebGLMultipleRenderTargets===!0;if(oe)for(let Me=0;Me<x.length;Me++)t.bindFramebuffer(i.FRAMEBUFFER,ne.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Me,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ne.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Me,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ne.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ne.__webglFramebuffer);for(let Me=0;Me<x.length;Me++){$.push(i.COLOR_ATTACHMENT0+Me),S.depthBuffer&&$.push(pe);const ke=ne.__ignoreDepthValues!==void 0?ne.__ignoreDepthValues:!1;if(ke===!1&&(S.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),S.stencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),oe&&i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ne.__webglColorRenderbuffer[Me]),ke===!0&&(i.invalidateFramebuffer(i.READ_FRAMEBUFFER,[pe]),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[pe])),oe){const re=r.get(x[Me]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,re,0)}i.blitFramebuffer(0,0,U,te,0,0,U,te,Z,i.NEAREST),f&&i.invalidateFramebuffer(i.READ_FRAMEBUFFER,$)}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),oe)for(let Me=0;Me<x.length;Me++){t.bindFramebuffer(i.FRAMEBUFFER,ne.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Me,i.RENDERBUFFER,ne.__webglColorRenderbuffer[Me]);const ke=r.get(x[Me]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ne.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Me,i.TEXTURE_2D,ke,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ne.__webglMultisampledFramebuffer)}}function Re(S){return Math.min(h,S.samples)}function We(S){const x=r.get(S);return s&&S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function ut(S){const x=o.render.frame;g.get(S)!==x&&(g.set(S,x),S.update())}function ht(S,x){const U=S.colorSpace,te=S.format,Z=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||S.format===ma||U!==ar&&U!==zt&&(je.getTransfer(U)===Je?s===!1?e.has("EXT_sRGB")===!0&&te===Xt?(S.format=ma,S.minFilter=Ft,S.generateMipmaps=!1):x=zo.sRGBToLinear(x):(te!==Xt||Z!==mr)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",U)),x}this.allocateTextureUnit=ee,this.resetTextureUnits=W,this.setTexture2D=K,this.setTexture2DArray=Q,this.setTexture3D=ue,this.setTextureCube=B,this.rebindTextures=Fe,this.setupRenderTarget=Se,this.updateRenderTargetMipmap=Ze,this.updateMultisampleRenderTarget=Ne,this.setupDepthRenderbuffer=ve,this.setupFrameBufferTexture=Le,this.useMultisampledRTT=We}function vf(i,e,t){const r=t.isWebGL2;function n(a,o=zt){let s;const l=je.getTransfer(o);if(a===mr)return i.UNSIGNED_BYTE;if(a===Co)return i.UNSIGNED_SHORT_4_4_4_4;if(a===Po)return i.UNSIGNED_SHORT_5_5_5_1;if(a===ec)return i.BYTE;if(a===tc)return i.SHORT;if(a===Aa)return i.UNSIGNED_SHORT;if(a===Ro)return i.INT;if(a===hr)return i.UNSIGNED_INT;if(a===dr)return i.FLOAT;if(a===bi)return r?i.HALF_FLOAT:(s=e.get("OES_texture_half_float"),s!==null?s.HALF_FLOAT_OES:null);if(a===rc)return i.ALPHA;if(a===Xt)return i.RGBA;if(a===ic)return i.LUMINANCE;if(a===nc)return i.LUMINANCE_ALPHA;if(a===Cr)return i.DEPTH_COMPONENT;if(a===ni)return i.DEPTH_STENCIL;if(a===ma)return s=e.get("EXT_sRGB"),s!==null?s.SRGB_ALPHA_EXT:null;if(a===ac)return i.RED;if(a===Lo)return i.RED_INTEGER;if(a===sc)return i.RG;if(a===Do)return i.RG_INTEGER;if(a===Uo)return i.RGBA_INTEGER;if(a===Cn||a===Pn||a===Ln||a===Dn)if(l===Je)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(a===Cn)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(a===Pn)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(a===Ln)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(a===Dn)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(a===Cn)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(a===Pn)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===Ln)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===Dn)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(a===$a||a===es||a===ts||a===rs)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(a===$a)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(a===es)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(a===ts)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(a===rs)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(a===No)return s=e.get("WEBGL_compressed_texture_etc1"),s!==null?s.COMPRESSED_RGB_ETC1_WEBGL:null;if(a===is||a===ns)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(a===is)return l===Je?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(a===ns)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(a===as||a===ss||a===os||a===ls||a===cs||a===us||a===hs||a===ds||a===ps||a===fs||a===ms||a===gs||a===_s||a===vs)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(a===as)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(a===ss)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(a===os)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(a===ls)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(a===cs)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(a===us)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(a===hs)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(a===ds)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(a===ps)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(a===fs)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(a===ms)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(a===gs)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(a===_s)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(a===vs)return l===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(a===Un||a===xs||a===ys)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(a===Un)return l===Je?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(a===xs)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(a===ys)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(a===oc||a===Ms||a===Ss||a===Es)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(a===Un)return s.COMPRESSED_RED_RGTC1_EXT;if(a===Ms)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(a===Ss)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(a===Es)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return a===Rr?r?i.UNSIGNED_INT_24_8:(s=e.get("WEBGL_depth_texture"),s!==null?s.UNSIGNED_INT_24_8_WEBGL:null):i[a]!==void 0?i[a]:null}return{convert:n}}class xf extends Bt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class wt extends pt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const yf={type:"move"};class na{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new wt,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new wt,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new C,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new C),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new wt,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new C,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new C),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const r of e.hand.values())this._getHandJoint(t,r)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,r){let n=null,a=null,o=null;const s=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const _ of e.hand.values()){const m=t.getJointPose(_,r),d=this._getHandJoint(c,_);m!==null&&(d.matrix.fromArray(m.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,d.jointRadius=m.radius),d.visible=m!==null}const u=c.joints["index-finger-tip"],h=c.joints["thumb-tip"],p=u.position.distanceTo(h.position),f=.02,g=.005;c.inputState.pinching&&p>f+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&p<=f-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(a=t.getPose(e.gripSpace,r),a!==null&&(l.matrix.fromArray(a.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,a.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(a.linearVelocity)):l.hasLinearVelocity=!1,a.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(a.angularVelocity)):l.hasAngularVelocity=!1));s!==null&&(n=t.getPose(e.targetRaySpace,r),n===null&&a!==null&&(n=a),n!==null&&(s.matrix.fromArray(n.transform.matrix),s.matrix.decompose(s.position,s.rotation,s.scale),s.matrixWorldNeedsUpdate=!0,n.linearVelocity?(s.hasLinearVelocity=!0,s.linearVelocity.copy(n.linearVelocity)):s.hasLinearVelocity=!1,n.angularVelocity?(s.hasAngularVelocity=!0,s.angularVelocity.copy(n.angularVelocity)):s.hasAngularVelocity=!1,this.dispatchEvent(yf)))}return s!==null&&(s.visible=n!==null),l!==null&&(l.visible=a!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const r=new wt;r.matrixAutoUpdate=!1,r.visible=!1,e.joints[t.jointName]=r,e.add(r)}return e.joints[t.jointName]}}class Mf extends si{constructor(e,t){super();const r=this;let n=null,a=1,o=null,s="local-floor",l=1,c=null,u=null,h=null,p=null,f=null,g=null;const _=t.getContextAttributes();let m=null,d=null;const E=[],v=[],T=new he;let w=null;const A=new Bt;A.layers.enable(1),A.viewport=new ct;const L=new Bt;L.layers.enable(2),L.viewport=new ct;const V=[A,L],y=new xf;y.layers.enable(1),y.layers.enable(2);let b=null,G=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(B){let Y=E[B];return Y===void 0&&(Y=new na,E[B]=Y),Y.getTargetRaySpace()},this.getControllerGrip=function(B){let Y=E[B];return Y===void 0&&(Y=new na,E[B]=Y),Y.getGripSpace()},this.getHand=function(B){let Y=E[B];return Y===void 0&&(Y=new na,E[B]=Y),Y.getHandSpace()};function H(B){const Y=v.indexOf(B.inputSource);if(Y===-1)return;const de=E[Y];de!==void 0&&(de.update(B.inputSource,B.frame,c||o),de.dispatchEvent({type:B.type,data:B.inputSource}))}function q(){n.removeEventListener("select",H),n.removeEventListener("selectstart",H),n.removeEventListener("selectend",H),n.removeEventListener("squeeze",H),n.removeEventListener("squeezestart",H),n.removeEventListener("squeezeend",H),n.removeEventListener("end",q),n.removeEventListener("inputsourceschange",P);for(let B=0;B<E.length;B++){const Y=v[B];Y!==null&&(v[B]=null,E[B].disconnect(Y))}b=null,G=null,e.setRenderTarget(m),f=null,p=null,h=null,n=null,d=null,ue.stop(),r.isPresenting=!1,e.setPixelRatio(w),e.setSize(T.width,T.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(B){a=B,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(B){s=B,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(B){c=B},this.getBaseLayer=function(){return p!==null?p:f},this.getBinding=function(){return h},this.getFrame=function(){return g},this.getSession=function(){return n},this.setSession=async function(B){if(n=B,n!==null){if(m=e.getRenderTarget(),n.addEventListener("select",H),n.addEventListener("selectstart",H),n.addEventListener("selectend",H),n.addEventListener("squeeze",H),n.addEventListener("squeezestart",H),n.addEventListener("squeezeend",H),n.addEventListener("end",q),n.addEventListener("inputsourceschange",P),_.xrCompatible!==!0&&await t.makeXRCompatible(),w=e.getPixelRatio(),e.getSize(T),n.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const Y={antialias:n.renderState.layers===void 0?_.antialias:!0,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:a};f=new XRWebGLLayer(n,t,Y),n.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),d=new Lr(f.framebufferWidth,f.framebufferHeight,{format:Xt,type:mr,colorSpace:e.outputColorSpace,stencilBuffer:_.stencil})}else{let Y=null,de=null,fe=null;_.depth&&(fe=_.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,Y=_.stencil?ni:Cr,de=_.stencil?Rr:hr);const ge={colorFormat:t.RGBA8,depthFormat:fe,scaleFactor:a};h=new XRWebGLBinding(n,t),p=h.createProjectionLayer(ge),n.updateRenderState({layers:[p]}),e.setPixelRatio(1),e.setSize(p.textureWidth,p.textureHeight,!1),d=new Lr(p.textureWidth,p.textureHeight,{format:Xt,type:mr,depthTexture:new Jo(p.textureWidth,p.textureHeight,de,void 0,void 0,void 0,void 0,void 0,void 0,Y),stencilBuffer:_.stencil,colorSpace:e.outputColorSpace,samples:_.antialias?4:0});const Ce=e.properties.get(d);Ce.__ignoreDepthValues=p.ignoreDepthValues}d.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await n.requestReferenceSpace(s),ue.setContext(n),ue.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(n!==null)return n.environmentBlendMode};function P(B){for(let Y=0;Y<B.removed.length;Y++){const de=B.removed[Y],fe=v.indexOf(de);fe>=0&&(v[fe]=null,E[fe].disconnect(de))}for(let Y=0;Y<B.added.length;Y++){const de=B.added[Y];let fe=v.indexOf(de);if(fe===-1){for(let Ce=0;Ce<E.length;Ce++)if(Ce>=v.length){v.push(de),fe=Ce;break}else if(v[Ce]===null){v[Ce]=de,fe=Ce;break}if(fe===-1)break}const ge=E[fe];ge&&ge.connect(de)}}const z=new C,X=new C;function W(B,Y,de){z.setFromMatrixPosition(Y.matrixWorld),X.setFromMatrixPosition(de.matrixWorld);const fe=z.distanceTo(X),ge=Y.projectionMatrix.elements,Ce=de.projectionMatrix.elements,we=ge[14]/(ge[10]-1),Te=ge[14]/(ge[10]+1),Le=(ge[9]+1)/ge[5],I=(ge[9]-1)/ge[5],yt=(ge[8]-1)/ge[0],ve=(Ce[8]+1)/Ce[0],Fe=we*yt,Se=we*ve,Ze=fe/(-yt+ve),Ne=Ze*-yt;Y.matrixWorld.decompose(B.position,B.quaternion,B.scale),B.translateX(Ne),B.translateZ(Ze),B.matrixWorld.compose(B.position,B.quaternion,B.scale),B.matrixWorldInverse.copy(B.matrixWorld).invert();const Re=we+Ze,We=Te+Ze,ut=Fe-Ne,ht=Se+(fe-Ne),S=Le*Te/We*Re,x=I*Te/We*Re;B.projectionMatrix.makePerspective(ut,ht,S,x,Re,We),B.projectionMatrixInverse.copy(B.projectionMatrix).invert()}function ee(B,Y){Y===null?B.matrixWorld.copy(B.matrix):B.matrixWorld.multiplyMatrices(Y.matrixWorld,B.matrix),B.matrixWorldInverse.copy(B.matrixWorld).invert()}this.updateCamera=function(B){if(n===null)return;y.near=L.near=A.near=B.near,y.far=L.far=A.far=B.far,(b!==y.near||G!==y.far)&&(n.updateRenderState({depthNear:y.near,depthFar:y.far}),b=y.near,G=y.far);const Y=B.parent,de=y.cameras;ee(y,Y);for(let fe=0;fe<de.length;fe++)ee(de[fe],Y);de.length===2?W(y,A,L):y.projectionMatrix.copy(A.projectionMatrix),j(B,y,Y)};function j(B,Y,de){de===null?B.matrix.copy(Y.matrixWorld):(B.matrix.copy(de.matrixWorld),B.matrix.invert(),B.matrix.multiply(Y.matrixWorld)),B.matrix.decompose(B.position,B.quaternion,B.scale),B.updateMatrixWorld(!0),B.projectionMatrix.copy(Y.projectionMatrix),B.projectionMatrixInverse.copy(Y.projectionMatrixInverse),B.isPerspectiveCamera&&(B.fov=ga*2*Math.atan(1/B.projectionMatrix.elements[5]),B.zoom=1)}this.getCamera=function(){return y},this.getFoveation=function(){if(!(p===null&&f===null))return l},this.setFoveation=function(B){l=B,p!==null&&(p.fixedFoveation=B),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=B)};let K=null;function Q(B,Y){if(u=Y.getViewerPose(c||o),g=Y,u!==null){const de=u.views;f!==null&&(e.setRenderTargetFramebuffer(d,f.framebuffer),e.setRenderTarget(d));let fe=!1;de.length!==y.cameras.length&&(y.cameras.length=0,fe=!0);for(let ge=0;ge<de.length;ge++){const Ce=de[ge];let we=null;if(f!==null)we=f.getViewport(Ce);else{const Le=h.getViewSubImage(p,Ce);we=Le.viewport,ge===0&&(e.setRenderTargetTextures(d,Le.colorTexture,p.ignoreDepthValues?void 0:Le.depthStencilTexture),e.setRenderTarget(d))}let Te=V[ge];Te===void 0&&(Te=new Bt,Te.layers.enable(ge),Te.viewport=new ct,V[ge]=Te),Te.matrix.fromArray(Ce.transform.matrix),Te.matrix.decompose(Te.position,Te.quaternion,Te.scale),Te.projectionMatrix.fromArray(Ce.projectionMatrix),Te.projectionMatrixInverse.copy(Te.projectionMatrix).invert(),Te.viewport.set(we.x,we.y,we.width,we.height),ge===0&&(y.matrix.copy(Te.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),fe===!0&&y.cameras.push(Te)}}for(let de=0;de<E.length;de++){const fe=v[de],ge=E[de];fe!==null&&ge!==void 0&&ge.update(fe,Y,c||o)}K&&K(B,Y),Y.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:Y}),g=null}const ue=new Yo;ue.setAnimationLoop(Q),this.setAnimationLoop=function(B){K=B},this.dispose=function(){}}}function Sf(i,e){function t(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function r(m,d){d.color.getRGB(m.fogColor.value,Xo(i)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function n(m,d,E,v,T){d.isMeshBasicMaterial||d.isMeshLambertMaterial?a(m,d):d.isMeshToonMaterial?(a(m,d),h(m,d)):d.isMeshPhongMaterial?(a(m,d),u(m,d)):d.isMeshStandardMaterial?(a(m,d),p(m,d),d.isMeshPhysicalMaterial&&f(m,d,T)):d.isMeshMatcapMaterial?(a(m,d),g(m,d)):d.isMeshDepthMaterial?a(m,d):d.isMeshDistanceMaterial?(a(m,d),_(m,d)):d.isMeshNormalMaterial?a(m,d):d.isLineBasicMaterial?(o(m,d),d.isLineDashedMaterial&&s(m,d)):d.isPointsMaterial?l(m,d,E,v):d.isSpriteMaterial?c(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function a(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,t(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===At&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,t(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===At&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,t(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,t(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const E=e.get(d).envMap;if(E&&(m.envMap.value=E,m.flipEnvMap.value=E.isCubeTexture&&E.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap){m.lightMap.value=d.lightMap;const v=i._useLegacyLights===!0?Math.PI:1;m.lightMapIntensity.value=d.lightMapIntensity*v,t(d.lightMap,m.lightMapTransform)}d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,m.aoMapTransform))}function o(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform))}function s(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function l(m,d,E,v){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*E,m.scale.value=v*.5,d.map&&(m.map.value=d.map,t(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function c(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function u(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function h(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function p(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,m.roughnessMapTransform)),e.get(d).envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function f(m,d,E){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===At&&m.clearcoatNormalScale.value.negate())),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=E.texture,m.transmissionSamplerSize.value.set(E.width,E.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,d){d.matcap&&(m.matcap.value=d.matcap)}function _(m,d){const E=e.get(d).light;m.referencePosition.value.setFromMatrixPosition(E.matrixWorld),m.nearDistance.value=E.shadow.camera.near,m.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:n}}function Ef(i,e,t,r){let n={},a={},o=[];const s=t.isWebGL2?i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(E,v){const T=v.program;r.uniformBlockBinding(E,T)}function c(E,v){let T=n[E.id];T===void 0&&(g(E),T=u(E),n[E.id]=T,E.addEventListener("dispose",m));const w=v.program;r.updateUBOMapping(E,w);const A=e.render.frame;a[E.id]!==A&&(p(E),a[E.id]=A)}function u(E){const v=h();E.__bindingPointIndex=v;const T=i.createBuffer(),w=E.__size,A=E.usage;return i.bindBuffer(i.UNIFORM_BUFFER,T),i.bufferData(i.UNIFORM_BUFFER,w,A),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,v,T),T}function h(){for(let E=0;E<s;E++)if(o.indexOf(E)===-1)return o.push(E),E;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function p(E){const v=n[E.id],T=E.uniforms,w=E.__cache;i.bindBuffer(i.UNIFORM_BUFFER,v);for(let A=0,L=T.length;A<L;A++){const V=T[A];if(f(V,A,w)===!0){const y=V.__offset,b=Array.isArray(V.value)?V.value:[V.value];let G=0;for(let H=0;H<b.length;H++){const q=b[H],P=_(q);typeof q=="number"?(V.__data[0]=q,i.bufferSubData(i.UNIFORM_BUFFER,y+G,V.__data)):q.isMatrix3?(V.__data[0]=q.elements[0],V.__data[1]=q.elements[1],V.__data[2]=q.elements[2],V.__data[3]=q.elements[0],V.__data[4]=q.elements[3],V.__data[5]=q.elements[4],V.__data[6]=q.elements[5],V.__data[7]=q.elements[0],V.__data[8]=q.elements[6],V.__data[9]=q.elements[7],V.__data[10]=q.elements[8],V.__data[11]=q.elements[0]):(q.toArray(V.__data,G),G+=P.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,y,V.__data)}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function f(E,v,T){const w=E.value;if(T[v]===void 0){if(typeof w=="number")T[v]=w;else{const A=Array.isArray(w)?w:[w],L=[];for(let V=0;V<A.length;V++)L.push(A[V].clone());T[v]=L}return!0}else if(typeof w=="number"){if(T[v]!==w)return T[v]=w,!0}else{const A=Array.isArray(T[v])?T[v]:[T[v]],L=Array.isArray(w)?w:[w];for(let V=0;V<A.length;V++){const y=A[V];if(y.equals(L[V])===!1)return y.copy(L[V]),!0}}return!1}function g(E){const v=E.uniforms;let T=0;const w=16;let A=0;for(let L=0,V=v.length;L<V;L++){const y=v[L],b={boundary:0,storage:0},G=Array.isArray(y.value)?y.value:[y.value];for(let H=0,q=G.length;H<q;H++){const P=G[H],z=_(P);b.boundary+=z.boundary,b.storage+=z.storage}if(y.__data=new Float32Array(b.storage/Float32Array.BYTES_PER_ELEMENT),y.__offset=T,L>0){A=T%w;const H=w-A;A!==0&&H-b.boundary<0&&(T+=w-A,y.__offset=T)}T+=b.storage}return A=T%w,A>0&&(T+=w-A),E.__size=T,E.__cache={},this}function _(E){const v={boundary:0,storage:0};return typeof E=="number"?(v.boundary=4,v.storage=4):E.isVector2?(v.boundary=8,v.storage=8):E.isVector3||E.isColor?(v.boundary=16,v.storage=12):E.isVector4?(v.boundary=16,v.storage=16):E.isMatrix3?(v.boundary=48,v.storage=48):E.isMatrix4?(v.boundary=64,v.storage=64):E.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",E),v}function m(E){const v=E.target;v.removeEventListener("dispose",m);const T=o.indexOf(v.__bindingPointIndex);o.splice(T,1),i.deleteBuffer(n[v.id]),delete n[v.id],delete a[v.id]}function d(){for(const E in n)i.deleteBuffer(n[E]);o=[],n={},a={}}return{bind:l,update:c,dispose:d}}class rl{constructor(e={}){const{canvas:t=xc(),context:r=null,depth:n=!0,stencil:a=!0,alpha:o=!1,antialias:s=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1}=e;this.isWebGLRenderer=!0;let p;r!==null?p=r.getContextAttributes().alpha:p=o;const f=new Uint32Array(4),g=new Int32Array(4);let _=null,m=null;const d=[],E=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=dt,this._useLegacyLights=!1,this.toneMapping=fr,this.toneMappingExposure=1;const v=this;let T=!1,w=0,A=0,L=null,V=-1,y=null;const b=new ct,G=new ct;let H=null;const q=new Ve(0);let P=0,z=t.width,X=t.height,W=1,ee=null,j=null;const K=new ct(0,0,z,X),Q=new ct(0,0,z,X);let ue=!1;const B=new Da;let Y=!1,de=!1,fe=null;const ge=new tt,Ce=new he,we=new C,Te={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function Le(){return L===null?W:1}let I=r;function yt(M,D){for(let O=0;O<M.length;O++){const F=M[O],N=t.getContext(F,D);if(N!==null)return N}return null}try{const M={alpha:!0,depth:n,stencil:a,antialias:s,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${wa}`),t.addEventListener("webglcontextlost",Be,!1),t.addEventListener("webglcontextrestored",R,!1),t.addEventListener("webglcontextcreationerror",le,!1),I===null){const D=["webgl2","webgl","experimental-webgl"];if(v.isWebGL1Renderer===!0&&D.shift(),I=yt(D,M),I===null)throw yt(D)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&I instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),I.getShaderPrecisionFormat===void 0&&(I.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(M){throw console.error("THREE.WebGLRenderer: "+M.message),M}let ve,Fe,Se,Ze,Ne,Re,We,ut,ht,S,x,U,te,Z,$,pe,ne,oe,Me,ke,re,Xe,Ae,Ee;function xe(){ve=new Ud(I),Fe=new Ad(I,ve,e),ve.init(Fe),Xe=new vf(I,ve,Fe),Se=new gf(I,ve,Fe),Ze=new Od(I),Ne=new tf,Re=new _f(I,ve,Se,Ne,Fe,Xe,Ze),We=new Cd(v),ut=new Dd(v),ht=new Wc(I,Fe),Ae=new bd(I,ve,ht,Fe),S=new Nd(I,ht,Ze,Ae),x=new Hd(I,S,ht,Ze),Me=new zd(I,Fe,Re),pe=new Rd(Ne),U=new ef(v,We,ut,ve,Fe,Ae,pe),te=new Sf(v,Ne),Z=new nf,$=new uf(ve,Fe),oe=new Td(v,We,ut,Se,x,p,l),ne=new mf(v,x,Fe),Ee=new Ef(I,Ze,Fe,Se),ke=new wd(I,ve,Ze,Fe),re=new Id(I,ve,Ze,Fe),Ze.programs=U.programs,v.capabilities=Fe,v.extensions=ve,v.properties=Ne,v.renderLists=Z,v.shadowMap=ne,v.state=Se,v.info=Ze}xe();const ce=new Mf(v,I);this.xr=ce,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){const M=ve.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=ve.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return W},this.setPixelRatio=function(M){M!==void 0&&(W=M,this.setSize(z,X,!1))},this.getSize=function(M){return M.set(z,X)},this.setSize=function(M,D,O=!0){if(ce.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}z=M,X=D,t.width=Math.floor(M*W),t.height=Math.floor(D*W),O===!0&&(t.style.width=M+"px",t.style.height=D+"px"),this.setViewport(0,0,M,D)},this.getDrawingBufferSize=function(M){return M.set(z*W,X*W).floor()},this.setDrawingBufferSize=function(M,D,O){z=M,X=D,W=O,t.width=Math.floor(M*O),t.height=Math.floor(D*O),this.setViewport(0,0,M,D)},this.getCurrentViewport=function(M){return M.copy(b)},this.getViewport=function(M){return M.copy(K)},this.setViewport=function(M,D,O,F){M.isVector4?K.set(M.x,M.y,M.z,M.w):K.set(M,D,O,F),Se.viewport(b.copy(K).multiplyScalar(W).floor())},this.getScissor=function(M){return M.copy(Q)},this.setScissor=function(M,D,O,F){M.isVector4?Q.set(M.x,M.y,M.z,M.w):Q.set(M,D,O,F),Se.scissor(G.copy(Q).multiplyScalar(W).floor())},this.getScissorTest=function(){return ue},this.setScissorTest=function(M){Se.setScissorTest(ue=M)},this.setOpaqueSort=function(M){ee=M},this.setTransparentSort=function(M){j=M},this.getClearColor=function(M){return M.copy(oe.getClearColor())},this.setClearColor=function(){oe.setClearColor.apply(oe,arguments)},this.getClearAlpha=function(){return oe.getClearAlpha()},this.setClearAlpha=function(){oe.setClearAlpha.apply(oe,arguments)},this.clear=function(M=!0,D=!0,O=!0){let F=0;if(M){let N=!1;if(L!==null){const ae=L.texture.format;N=ae===Uo||ae===Do||ae===Lo}if(N){const ae=L.texture.type,_e=ae===mr||ae===hr||ae===Aa||ae===Rr||ae===Co||ae===Po,ye=oe.getClearColor(),be=oe.getClearAlpha(),ze=ye.r,De=ye.g,Ue=ye.b;_e?(f[0]=ze,f[1]=De,f[2]=Ue,f[3]=be,I.clearBufferuiv(I.COLOR,0,f)):(g[0]=ze,g[1]=De,g[2]=Ue,g[3]=be,I.clearBufferiv(I.COLOR,0,g))}else F|=I.COLOR_BUFFER_BIT}D&&(F|=I.DEPTH_BUFFER_BIT),O&&(F|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),I.clear(F)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Be,!1),t.removeEventListener("webglcontextrestored",R,!1),t.removeEventListener("webglcontextcreationerror",le,!1),Z.dispose(),$.dispose(),Ne.dispose(),We.dispose(),ut.dispose(),x.dispose(),Ae.dispose(),Ee.dispose(),U.dispose(),ce.dispose(),ce.removeEventListener("sessionstart",Ut),ce.removeEventListener("sessionend",Ye),fe&&(fe.dispose(),fe=null),Mt.stop()};function Be(M){M.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),T=!0}function R(){console.log("THREE.WebGLRenderer: Context Restored."),T=!1;const M=Ze.autoReset,D=ne.enabled,O=ne.autoUpdate,F=ne.needsUpdate,N=ne.type;xe(),Ze.autoReset=M,ne.enabled=D,ne.autoUpdate=O,ne.needsUpdate=F,ne.type=N}function le(M){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function J(M){const D=M.target;D.removeEventListener("dispose",J),k(D)}function k(M){ie(M),Ne.remove(M)}function ie(M){const D=Ne.get(M).programs;D!==void 0&&(D.forEach(function(O){U.releaseProgram(O)}),M.isShaderMaterial&&U.releaseShaderCache(M))}this.renderBufferDirect=function(M,D,O,F,N,ae){D===null&&(D=Te);const _e=N.isMesh&&N.matrixWorld.determinant()<0,ye=_l(M,D,O,F,N);Se.setMaterial(F,_e);let be=O.index,ze=1;if(F.wireframe===!0){if(be=S.getWireframeAttribute(O),be===void 0)return;ze=2}const De=O.drawRange,Ue=O.attributes.position;let ft=De.start*ze,nt=(De.start+De.count)*ze;ae!==null&&(ft=Math.max(ft,ae.start*ze),nt=Math.min(nt,(ae.start+ae.count)*ze)),be!==null?(ft=Math.max(ft,0),nt=Math.min(nt,be.count)):Ue!=null&&(ft=Math.max(ft,0),nt=Math.min(nt,Ue.count));const Nt=nt-ft;if(Nt<0||Nt===1/0)return;Ae.setup(N,F,ye,O,be);let Jt,$e=ke;if(be!==null&&(Jt=ht.get(be),$e=re,$e.setIndex(Jt)),N.isMesh)F.wireframe===!0?(Se.setLineWidth(F.wireframeLinewidth*Le()),$e.setMode(I.LINES)):$e.setMode(I.TRIANGLES);else if(N.isLine){let Ie=F.linewidth;Ie===void 0&&(Ie=1),Se.setLineWidth(Ie*Le()),N.isLineSegments?$e.setMode(I.LINES):N.isLineLoop?$e.setMode(I.LINE_LOOP):$e.setMode(I.LINE_STRIP)}else N.isPoints?$e.setMode(I.POINTS):N.isSprite&&$e.setMode(I.TRIANGLES);if(N.isBatchedMesh)$e.renderMultiDraw(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount);else if(N.isInstancedMesh)$e.renderInstances(ft,Nt,N.count);else if(O.isInstancedBufferGeometry){const Ie=O._maxInstanceCount!==void 0?O._maxInstanceCount:1/0,En=Math.min(O.instanceCount,Ie);$e.renderInstances(ft,Nt,En)}else $e.render(ft,Nt)};function me(M,D,O){M.transparent===!0&&M.side===ir&&M.forceSinglePass===!1?(M.side=At,M.needsUpdate=!0,Ui(M,D,O),M.side=gr,M.needsUpdate=!0,Ui(M,D,O),M.side=ir):Ui(M,D,O)}this.compile=function(M,D,O=null){O===null&&(O=M),m=$.get(O),m.init(),E.push(m),O.traverseVisible(function(N){N.isLight&&N.layers.test(D.layers)&&(m.pushLight(N),N.castShadow&&m.pushShadow(N))}),M!==O&&M.traverseVisible(function(N){N.isLight&&N.layers.test(D.layers)&&(m.pushLight(N),N.castShadow&&m.pushShadow(N))}),m.setupLights(v._useLegacyLights);const F=new Set;return M.traverse(function(N){const ae=N.material;if(ae)if(Array.isArray(ae))for(let _e=0;_e<ae.length;_e++){const ye=ae[_e];me(ye,O,N),F.add(ye)}else me(ae,O,N),F.add(ae)}),E.pop(),m=null,F},this.compileAsync=function(M,D,O=null){const F=this.compile(M,D,O);return new Promise(N=>{function ae(){if(F.forEach(function(_e){Ne.get(_e).currentProgram.isReady()&&F.delete(_e)}),F.size===0){N(M);return}setTimeout(ae,10)}ve.get("KHR_parallel_shader_compile")!==null?ae():setTimeout(ae,10)})};let qe=null;function rt(M){qe&&qe(M)}function Ut(){Mt.stop()}function Ye(){Mt.start()}const Mt=new Yo;Mt.setAnimationLoop(rt),typeof self<"u"&&Mt.setContext(self),this.setAnimationLoop=function(M){qe=M,ce.setAnimationLoop(M),M===null?Mt.stop():Mt.start()},ce.addEventListener("sessionstart",Ut),ce.addEventListener("sessionend",Ye),this.render=function(M,D){if(D!==void 0&&D.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(T===!0)return;M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),D.parent===null&&D.matrixWorldAutoUpdate===!0&&D.updateMatrixWorld(),ce.enabled===!0&&ce.isPresenting===!0&&(ce.cameraAutoUpdate===!0&&ce.updateCamera(D),D=ce.getCamera()),M.isScene===!0&&M.onBeforeRender(v,M,D,L),m=$.get(M,E.length),m.init(),E.push(m),ge.multiplyMatrices(D.projectionMatrix,D.matrixWorldInverse),B.setFromProjectionMatrix(ge),de=this.localClippingEnabled,Y=pe.init(this.clippingPlanes,de),_=Z.get(M,d.length),_.init(),d.push(_),qt(M,D,0,v.sortObjects),_.finish(),v.sortObjects===!0&&_.sort(ee,j),this.info.render.frame++,Y===!0&&pe.beginShadows();const O=m.state.shadowsArray;if(ne.render(O,M,D),Y===!0&&pe.endShadows(),this.info.autoReset===!0&&this.info.reset(),oe.render(_,M),m.setupLights(v._useLegacyLights),D.isArrayCamera){const F=D.cameras;for(let N=0,ae=F.length;N<ae;N++){const _e=F[N];Ha(_,M,_e,_e.viewport)}}else Ha(_,M,D);L!==null&&(Re.updateMultisampleRenderTarget(L),Re.updateRenderTargetMipmap(L)),M.isScene===!0&&M.onAfterRender(v,M,D),Ae.resetDefaultState(),V=-1,y=null,E.pop(),E.length>0?m=E[E.length-1]:m=null,d.pop(),d.length>0?_=d[d.length-1]:_=null};function qt(M,D,O,F){if(M.visible===!1)return;if(M.layers.test(D.layers)){if(M.isGroup)O=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(D);else if(M.isLight)m.pushLight(M),M.castShadow&&m.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||B.intersectsSprite(M)){F&&we.setFromMatrixPosition(M.matrixWorld).applyMatrix4(ge);const ae=x.update(M),_e=M.material;_e.visible&&_.push(M,ae,_e,O,we.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||B.intersectsObject(M))){const ae=x.update(M),_e=M.material;if(F&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),we.copy(M.boundingSphere.center)):(ae.boundingSphere===null&&ae.computeBoundingSphere(),we.copy(ae.boundingSphere.center)),we.applyMatrix4(M.matrixWorld).applyMatrix4(ge)),Array.isArray(_e)){const ye=ae.groups;for(let be=0,ze=ye.length;be<ze;be++){const De=ye[be],Ue=_e[De.materialIndex];Ue&&Ue.visible&&_.push(M,ae,Ue,O,we.z,De)}}else _e.visible&&_.push(M,ae,_e,O,we.z,null)}}const N=M.children;for(let ae=0,_e=N.length;ae<_e;ae++)qt(N[ae],D,O,F)}function Ha(M,D,O,F){const N=M.opaque,ae=M.transmissive,_e=M.transparent;m.setupLightsView(O),Y===!0&&pe.setGlobalState(v.clippingPlanes,O),ae.length>0&&gl(N,ae,D,O),F&&Se.viewport(b.copy(F)),N.length>0&&Di(N,D,O),ae.length>0&&Di(ae,D,O),_e.length>0&&Di(_e,D,O),Se.buffers.depth.setTest(!0),Se.buffers.depth.setMask(!0),Se.buffers.color.setMask(!0),Se.setPolygonOffset(!1)}function gl(M,D,O,F){if((O.isScene===!0?O.overrideMaterial:null)!==null)return;const N=Fe.isWebGL2;fe===null&&(fe=new Lr(1,1,{generateMipmaps:!0,type:ve.has("EXT_color_buffer_half_float")?bi:mr,minFilter:Ti,samples:N?4:0})),v.getDrawingBufferSize(Ce),N?fe.setSize(Ce.x,Ce.y):fe.setSize(_a(Ce.x),_a(Ce.y));const ae=v.getRenderTarget();v.setRenderTarget(fe),v.getClearColor(q),P=v.getClearAlpha(),P<1&&v.setClearColor(16777215,.5),v.clear();const _e=v.toneMapping;v.toneMapping=fr,Di(M,O,F),Re.updateMultisampleRenderTarget(fe),Re.updateRenderTargetMipmap(fe);let ye=!1;for(let be=0,ze=D.length;be<ze;be++){const De=D[be],Ue=De.object,ft=De.geometry,nt=De.material,Nt=De.group;if(nt.side===ir&&Ue.layers.test(F.layers)){const Jt=nt.side;nt.side=At,nt.needsUpdate=!0,Ga(Ue,O,F,ft,nt,Nt),nt.side=Jt,nt.needsUpdate=!0,ye=!0}}ye===!0&&(Re.updateMultisampleRenderTarget(fe),Re.updateRenderTargetMipmap(fe)),v.setRenderTarget(ae),v.setClearColor(q,P),v.toneMapping=_e}function Di(M,D,O){const F=D.isScene===!0?D.overrideMaterial:null;for(let N=0,ae=M.length;N<ae;N++){const _e=M[N],ye=_e.object,be=_e.geometry,ze=F===null?_e.material:F,De=_e.group;ye.layers.test(O.layers)&&Ga(ye,D,O,be,ze,De)}}function Ga(M,D,O,F,N,ae){M.onBeforeRender(v,D,O,F,N,ae),M.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),N.onBeforeRender(v,D,O,F,M,ae),N.transparent===!0&&N.side===ir&&N.forceSinglePass===!1?(N.side=At,N.needsUpdate=!0,v.renderBufferDirect(O,D,F,N,M,ae),N.side=gr,N.needsUpdate=!0,v.renderBufferDirect(O,D,F,N,M,ae),N.side=ir):v.renderBufferDirect(O,D,F,N,M,ae),M.onAfterRender(v,D,O,F,N,ae)}function Ui(M,D,O){D.isScene!==!0&&(D=Te);const F=Ne.get(M),N=m.state.lights,ae=m.state.shadowsArray,_e=N.state.version,ye=U.getParameters(M,N.state,ae,D,O),be=U.getProgramCacheKey(ye);let ze=F.programs;F.environment=M.isMeshStandardMaterial?D.environment:null,F.fog=D.fog,F.envMap=(M.isMeshStandardMaterial?ut:We).get(M.envMap||F.environment),ze===void 0&&(M.addEventListener("dispose",J),ze=new Map,F.programs=ze);let De=ze.get(be);if(De!==void 0){if(F.currentProgram===De&&F.lightsStateVersion===_e)return ka(M,ye),De}else ye.uniforms=U.getUniforms(M),M.onBuild(O,ye,v),M.onBeforeCompile(ye,v),De=U.acquireProgram(ye,be),ze.set(be,De),F.uniforms=ye.uniforms;const Ue=F.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Ue.clippingPlanes=pe.uniform),ka(M,ye),F.needsLights=xl(M),F.lightsStateVersion=_e,F.needsLights&&(Ue.ambientLightColor.value=N.state.ambient,Ue.lightProbe.value=N.state.probe,Ue.directionalLights.value=N.state.directional,Ue.directionalLightShadows.value=N.state.directionalShadow,Ue.spotLights.value=N.state.spot,Ue.spotLightShadows.value=N.state.spotShadow,Ue.rectAreaLights.value=N.state.rectArea,Ue.ltc_1.value=N.state.rectAreaLTC1,Ue.ltc_2.value=N.state.rectAreaLTC2,Ue.pointLights.value=N.state.point,Ue.pointLightShadows.value=N.state.pointShadow,Ue.hemisphereLights.value=N.state.hemi,Ue.directionalShadowMap.value=N.state.directionalShadowMap,Ue.directionalShadowMatrix.value=N.state.directionalShadowMatrix,Ue.spotShadowMap.value=N.state.spotShadowMap,Ue.spotLightMatrix.value=N.state.spotLightMatrix,Ue.spotLightMap.value=N.state.spotLightMap,Ue.pointShadowMap.value=N.state.pointShadowMap,Ue.pointShadowMatrix.value=N.state.pointShadowMatrix),F.currentProgram=De,F.uniformsList=null,De}function Va(M){if(M.uniformsList===null){const D=M.currentProgram.getUniforms();M.uniformsList=ln.seqWithValue(D.seq,M.uniforms)}return M.uniformsList}function ka(M,D){const O=Ne.get(M);O.outputColorSpace=D.outputColorSpace,O.batching=D.batching,O.instancing=D.instancing,O.instancingColor=D.instancingColor,O.skinning=D.skinning,O.morphTargets=D.morphTargets,O.morphNormals=D.morphNormals,O.morphColors=D.morphColors,O.morphTargetsCount=D.morphTargetsCount,O.numClippingPlanes=D.numClippingPlanes,O.numIntersection=D.numClipIntersection,O.vertexAlphas=D.vertexAlphas,O.vertexTangents=D.vertexTangents,O.toneMapping=D.toneMapping}function _l(M,D,O,F,N){D.isScene!==!0&&(D=Te),Re.resetTextureUnits();const ae=D.fog,_e=F.isMeshStandardMaterial?D.environment:null,ye=L===null?v.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:ar,be=(F.isMeshStandardMaterial?ut:We).get(F.envMap||_e),ze=F.vertexColors===!0&&!!O.attributes.color&&O.attributes.color.itemSize===4,De=!!O.attributes.tangent&&(!!F.normalMap||F.anisotropy>0),Ue=!!O.morphAttributes.position,ft=!!O.morphAttributes.normal,nt=!!O.morphAttributes.color;let Nt=fr;F.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(Nt=v.toneMapping);const Jt=O.morphAttributes.position||O.morphAttributes.normal||O.morphAttributes.color,$e=Jt!==void 0?Jt.length:0,Ie=Ne.get(F),En=m.state.lights;if(Y===!0&&(de===!0||M!==y)){const It=M===y&&F.id===V;pe.setState(F,M,It)}let Tn=!1;F.version===Ie.__version?(Ie.needsLights&&Ie.lightsStateVersion!==En.state.version||Ie.outputColorSpace!==ye||N.isBatchedMesh&&Ie.batching===!1||!N.isBatchedMesh&&Ie.batching===!0||N.isInstancedMesh&&Ie.instancing===!1||!N.isInstancedMesh&&Ie.instancing===!0||N.isSkinnedMesh&&Ie.skinning===!1||!N.isSkinnedMesh&&Ie.skinning===!0||N.isInstancedMesh&&Ie.instancingColor===!0&&N.instanceColor===null||N.isInstancedMesh&&Ie.instancingColor===!1&&N.instanceColor!==null||Ie.envMap!==be||F.fog===!0&&Ie.fog!==ae||Ie.numClippingPlanes!==void 0&&(Ie.numClippingPlanes!==pe.numPlanes||Ie.numIntersection!==pe.numIntersection)||Ie.vertexAlphas!==ze||Ie.vertexTangents!==De||Ie.morphTargets!==Ue||Ie.morphNormals!==ft||Ie.morphColors!==nt||Ie.toneMapping!==Nt||Fe.isWebGL2===!0&&Ie.morphTargetsCount!==$e)&&(Tn=!0):(Tn=!0,Ie.__version=F.version);let vr=Ie.currentProgram;Tn===!0&&(vr=Ui(F,D,N));let Wa=!1,di=!1,bn=!1;const mt=vr.getUniforms(),xr=Ie.uniforms;if(Se.useProgram(vr.program)&&(Wa=!0,di=!0,bn=!0),F.id!==V&&(V=F.id,di=!0),Wa||y!==M){mt.setValue(I,"projectionMatrix",M.projectionMatrix),mt.setValue(I,"viewMatrix",M.matrixWorldInverse);const It=mt.map.cameraPosition;It!==void 0&&It.setValue(I,we.setFromMatrixPosition(M.matrixWorld)),Fe.logarithmicDepthBuffer&&mt.setValue(I,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(F.isMeshPhongMaterial||F.isMeshToonMaterial||F.isMeshLambertMaterial||F.isMeshBasicMaterial||F.isMeshStandardMaterial||F.isShaderMaterial)&&mt.setValue(I,"isOrthographic",M.isOrthographicCamera===!0),y!==M&&(y=M,di=!0,bn=!0)}if(N.isSkinnedMesh){mt.setOptional(I,N,"bindMatrix"),mt.setOptional(I,N,"bindMatrixInverse");const It=N.skeleton;It&&(Fe.floatVertexTextures?(It.boneTexture===null&&It.computeBoneTexture(),mt.setValue(I,"boneTexture",It.boneTexture,Re)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}N.isBatchedMesh&&(mt.setOptional(I,N,"batchingTexture"),mt.setValue(I,"batchingTexture",N._matricesTexture,Re));const wn=O.morphAttributes;if((wn.position!==void 0||wn.normal!==void 0||wn.color!==void 0&&Fe.isWebGL2===!0)&&Me.update(N,O,vr),(di||Ie.receiveShadow!==N.receiveShadow)&&(Ie.receiveShadow=N.receiveShadow,mt.setValue(I,"receiveShadow",N.receiveShadow)),F.isMeshGouraudMaterial&&F.envMap!==null&&(xr.envMap.value=be,xr.flipEnvMap.value=be.isCubeTexture&&be.isRenderTargetTexture===!1?-1:1),di&&(mt.setValue(I,"toneMappingExposure",v.toneMappingExposure),Ie.needsLights&&vl(xr,bn),ae&&F.fog===!0&&te.refreshFogUniforms(xr,ae),te.refreshMaterialUniforms(xr,F,W,X,fe),ln.upload(I,Va(Ie),xr,Re)),F.isShaderMaterial&&F.uniformsNeedUpdate===!0&&(ln.upload(I,Va(Ie),xr,Re),F.uniformsNeedUpdate=!1),F.isSpriteMaterial&&mt.setValue(I,"center",N.center),mt.setValue(I,"modelViewMatrix",N.modelViewMatrix),mt.setValue(I,"normalMatrix",N.normalMatrix),mt.setValue(I,"modelMatrix",N.matrixWorld),F.isShaderMaterial||F.isRawShaderMaterial){const It=F.uniformsGroups;for(let An=0,yl=It.length;An<yl;An++)if(Fe.isWebGL2){const Xa=It[An];Ee.update(Xa,vr),Ee.bind(Xa,vr)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return vr}function vl(M,D){M.ambientLightColor.needsUpdate=D,M.lightProbe.needsUpdate=D,M.directionalLights.needsUpdate=D,M.directionalLightShadows.needsUpdate=D,M.pointLights.needsUpdate=D,M.pointLightShadows.needsUpdate=D,M.spotLights.needsUpdate=D,M.spotLightShadows.needsUpdate=D,M.rectAreaLights.needsUpdate=D,M.hemisphereLights.needsUpdate=D}function xl(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return w},this.getActiveMipmapLevel=function(){return A},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(M,D,O){Ne.get(M.texture).__webglTexture=D,Ne.get(M.depthTexture).__webglTexture=O;const F=Ne.get(M);F.__hasExternalTextures=!0,F.__hasExternalTextures&&(F.__autoAllocateDepthBuffer=O===void 0,F.__autoAllocateDepthBuffer||ve.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),F.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(M,D){const O=Ne.get(M);O.__webglFramebuffer=D,O.__useDefaultFramebuffer=D===void 0},this.setRenderTarget=function(M,D=0,O=0){L=M,w=D,A=O;let F=!0,N=null,ae=!1,_e=!1;if(M){const ye=Ne.get(M);ye.__useDefaultFramebuffer!==void 0?(Se.bindFramebuffer(I.FRAMEBUFFER,null),F=!1):ye.__webglFramebuffer===void 0?Re.setupRenderTarget(M):ye.__hasExternalTextures&&Re.rebindTextures(M,Ne.get(M.texture).__webglTexture,Ne.get(M.depthTexture).__webglTexture);const be=M.texture;(be.isData3DTexture||be.isDataArrayTexture||be.isCompressedArrayTexture)&&(_e=!0);const ze=Ne.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(ze[D])?N=ze[D][O]:N=ze[D],ae=!0):Fe.isWebGL2&&M.samples>0&&Re.useMultisampledRTT(M)===!1?N=Ne.get(M).__webglMultisampledFramebuffer:Array.isArray(ze)?N=ze[O]:N=ze,b.copy(M.viewport),G.copy(M.scissor),H=M.scissorTest}else b.copy(K).multiplyScalar(W).floor(),G.copy(Q).multiplyScalar(W).floor(),H=ue;if(Se.bindFramebuffer(I.FRAMEBUFFER,N)&&Fe.drawBuffers&&F&&Se.drawBuffers(M,N),Se.viewport(b),Se.scissor(G),Se.setScissorTest(H),ae){const ye=Ne.get(M.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+D,ye.__webglTexture,O)}else if(_e){const ye=Ne.get(M.texture),be=D||0;I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,ye.__webglTexture,O||0,be)}V=-1},this.readRenderTargetPixels=function(M,D,O,F,N,ae,_e){if(!(M&&M.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ye=Ne.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&_e!==void 0&&(ye=ye[_e]),ye){Se.bindFramebuffer(I.FRAMEBUFFER,ye);try{const be=M.texture,ze=be.format,De=be.type;if(ze!==Xt&&Xe.convert(ze)!==I.getParameter(I.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Ue=De===bi&&(ve.has("EXT_color_buffer_half_float")||Fe.isWebGL2&&ve.has("EXT_color_buffer_float"));if(De!==mr&&Xe.convert(De)!==I.getParameter(I.IMPLEMENTATION_COLOR_READ_TYPE)&&!(De===dr&&(Fe.isWebGL2||ve.has("OES_texture_float")||ve.has("WEBGL_color_buffer_float")))&&!Ue){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}D>=0&&D<=M.width-F&&O>=0&&O<=M.height-N&&I.readPixels(D,O,F,N,Xe.convert(ze),Xe.convert(De),ae)}finally{const be=L!==null?Ne.get(L).__webglFramebuffer:null;Se.bindFramebuffer(I.FRAMEBUFFER,be)}}},this.copyFramebufferToTexture=function(M,D,O=0){const F=Math.pow(2,-O),N=Math.floor(D.image.width*F),ae=Math.floor(D.image.height*F);Re.setTexture2D(D,0),I.copyTexSubImage2D(I.TEXTURE_2D,O,0,0,M.x,M.y,N,ae),Se.unbindTexture()},this.copyTextureToTexture=function(M,D,O,F=0){const N=D.image.width,ae=D.image.height,_e=Xe.convert(O.format),ye=Xe.convert(O.type);Re.setTexture2D(O,0),I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,O.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,O.unpackAlignment),D.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,F,M.x,M.y,N,ae,_e,ye,D.image.data):D.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,F,M.x,M.y,D.mipmaps[0].width,D.mipmaps[0].height,_e,D.mipmaps[0].data):I.texSubImage2D(I.TEXTURE_2D,F,M.x,M.y,_e,ye,D.image),F===0&&O.generateMipmaps&&I.generateMipmap(I.TEXTURE_2D),Se.unbindTexture()},this.copyTextureToTexture3D=function(M,D,O,F,N=0){if(v.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const ae=M.max.x-M.min.x+1,_e=M.max.y-M.min.y+1,ye=M.max.z-M.min.z+1,be=Xe.convert(F.format),ze=Xe.convert(F.type);let De;if(F.isData3DTexture)Re.setTexture3D(F,0),De=I.TEXTURE_3D;else if(F.isDataArrayTexture)Re.setTexture2DArray(F,0),De=I.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,F.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,F.unpackAlignment);const Ue=I.getParameter(I.UNPACK_ROW_LENGTH),ft=I.getParameter(I.UNPACK_IMAGE_HEIGHT),nt=I.getParameter(I.UNPACK_SKIP_PIXELS),Nt=I.getParameter(I.UNPACK_SKIP_ROWS),Jt=I.getParameter(I.UNPACK_SKIP_IMAGES),$e=O.isCompressedTexture?O.mipmaps[0]:O.image;I.pixelStorei(I.UNPACK_ROW_LENGTH,$e.width),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,$e.height),I.pixelStorei(I.UNPACK_SKIP_PIXELS,M.min.x),I.pixelStorei(I.UNPACK_SKIP_ROWS,M.min.y),I.pixelStorei(I.UNPACK_SKIP_IMAGES,M.min.z),O.isDataTexture||O.isData3DTexture?I.texSubImage3D(De,N,D.x,D.y,D.z,ae,_e,ye,be,ze,$e.data):O.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),I.compressedTexSubImage3D(De,N,D.x,D.y,D.z,ae,_e,ye,be,$e.data)):I.texSubImage3D(De,N,D.x,D.y,D.z,ae,_e,ye,be,ze,$e),I.pixelStorei(I.UNPACK_ROW_LENGTH,Ue),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,ft),I.pixelStorei(I.UNPACK_SKIP_PIXELS,nt),I.pixelStorei(I.UNPACK_SKIP_ROWS,Nt),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Jt),N===0&&F.generateMipmaps&&I.generateMipmap(De),Se.unbindTexture()},this.initTexture=function(M){M.isCubeTexture?Re.setTextureCube(M,0):M.isData3DTexture?Re.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?Re.setTexture2DArray(M,0):Re.setTexture2D(M,0),Se.unbindTexture()},this.resetState=function(){w=0,A=0,L=null,Se.reset(),Ae.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return nr}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===Ra?"display-p3":"srgb",t.unpackColorSpace=je.workingColorSpace===vn?"display-p3":"srgb"}get physicallyCorrectLights(){return console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),!this.useLegacyLights}set physicallyCorrectLights(e){console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),this.useLegacyLights=!e}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===dt?Pr:Io}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===Pr?dt:ar}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class Tf extends rl{}Tf.prototype.isWebGL1Renderer=!0;class bf extends pt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}}class Na extends li{constructor(e){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new Ve(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const po=new tt,xa=new Ca,rn=new xn,nn=new C;class il extends pt{constructor(e=new Dt,t=new Na){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=t,this.updateMorphTargets()}copy(e,t){return super.copy(e,t),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,t){const r=this.geometry,n=this.matrixWorld,a=e.params.Points.threshold,o=r.drawRange;if(r.boundingSphere===null&&r.computeBoundingSphere(),rn.copy(r.boundingSphere),rn.applyMatrix4(n),rn.radius+=a,e.ray.intersectsSphere(rn)===!1)return;po.copy(n).invert(),xa.copy(e.ray).applyMatrix4(po);const s=a/((this.scale.x+this.scale.y+this.scale.z)/3),l=s*s,c=r.index,u=r.attributes.position;if(c!==null){const h=Math.max(0,o.start),p=Math.min(c.count,o.start+o.count);for(let f=h,g=p;f<g;f++){const _=c.getX(f);nn.fromBufferAttribute(u,_),fo(nn,_,l,n,e,t,this)}}else{const h=Math.max(0,o.start),p=Math.min(u.count,o.start+o.count);for(let f=h,g=p;f<g;f++)nn.fromBufferAttribute(u,f),fo(nn,f,l,n,e,t,this)}}updateMorphTargets(){const e=this.geometry.morphAttributes,t=Object.keys(e);if(t.length>0){const r=e[t[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let n=0,a=r.length;n<a;n++){const o=r[n].name||String(n);this.morphTargetInfluences.push(0),this.morphTargetDictionary[o]=n}}}}}function fo(i,e,t,r,n,a,o){const s=xa.distanceSqToPoint(i);if(s<t){const l=new C;xa.closestPointToPoint(i,l),l.applyMatrix4(r);const c=n.ray.origin.distanceTo(l);if(c<n.near||c>n.far)return;a.push({distance:c,distanceToRay:Math.sqrt(s),point:l,index:e,face:null,object:o})}}class Kt{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(e,t){const r=this.getUtoTmapping(e);return this.getPoint(r,t)}getPoints(e=5){const t=[];for(let r=0;r<=e;r++)t.push(this.getPoint(r/e));return t}getSpacedPoints(e=5){const t=[];for(let r=0;r<=e;r++)t.push(this.getPointAt(r/e));return t}getLength(){const e=this.getLengths();return e[e.length-1]}getLengths(e=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===e+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const t=[];let r,n=this.getPoint(0),a=0;t.push(0);for(let o=1;o<=e;o++)r=this.getPoint(o/e),a+=r.distanceTo(n),t.push(a),n=r;return this.cacheArcLengths=t,t}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(e,t){const r=this.getLengths();let n=0;const a=r.length;let o;t?o=t:o=e*r[a-1];let s=0,l=a-1,c;for(;s<=l;)if(n=Math.floor(s+(l-s)/2),c=r[n]-o,c<0)s=n+1;else if(c>0)l=n-1;else{l=n;break}if(n=l,r[n]===o)return n/(a-1);const u=r[n],h=r[n+1]-u,p=(o-u)/h;return(n+p)/(a-1)}getTangent(e,t){let r=e-1e-4,n=e+1e-4;r<0&&(r=0),n>1&&(n=1);const a=this.getPoint(r),o=this.getPoint(n),s=t||(a.isVector2?new he:new C);return s.copy(o).sub(a).normalize(),s}getTangentAt(e,t){const r=this.getUtoTmapping(e);return this.getTangent(r,t)}computeFrenetFrames(e,t){const r=new C,n=[],a=[],o=[],s=new C,l=new tt;for(let f=0;f<=e;f++){const g=f/e;n[f]=this.getTangentAt(g,new C)}a[0]=new C,o[0]=new C;let c=Number.MAX_VALUE;const u=Math.abs(n[0].x),h=Math.abs(n[0].y),p=Math.abs(n[0].z);u<=c&&(c=u,r.set(1,0,0)),h<=c&&(c=h,r.set(0,1,0)),p<=c&&r.set(0,0,1),s.crossVectors(n[0],r).normalize(),a[0].crossVectors(n[0],s),o[0].crossVectors(n[0],a[0]);for(let f=1;f<=e;f++){if(a[f]=a[f-1].clone(),o[f]=o[f-1].clone(),s.crossVectors(n[f-1],n[f]),s.length()>Number.EPSILON){s.normalize();const g=Math.acos(vt(n[f-1].dot(n[f]),-1,1));a[f].applyMatrix4(l.makeRotationAxis(s,g))}o[f].crossVectors(n[f],a[f])}if(t===!0){let f=Math.acos(vt(a[0].dot(a[e]),-1,1));f/=e,n[0].dot(s.crossVectors(a[0],a[e]))>0&&(f=-f);for(let g=1;g<=e;g++)a[g].applyMatrix4(l.makeRotationAxis(n[g],f*g)),o[g].crossVectors(n[g],a[g])}return{tangents:n,normals:a,binormals:o}}clone(){return new this.constructor().copy(this)}copy(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}toJSON(){const e={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return e.arcLengthDivisions=this.arcLengthDivisions,e.type=this.type,e}fromJSON(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}}class Ia extends Kt{constructor(e=0,t=0,r=1,n=1,a=0,o=Math.PI*2,s=!1,l=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=e,this.aY=t,this.xRadius=r,this.yRadius=n,this.aStartAngle=a,this.aEndAngle=o,this.aClockwise=s,this.aRotation=l}getPoint(e,t){const r=t||new he,n=Math.PI*2;let a=this.aEndAngle-this.aStartAngle;const o=Math.abs(a)<Number.EPSILON;for(;a<0;)a+=n;for(;a>n;)a-=n;a<Number.EPSILON&&(o?a=0:a=n),this.aClockwise===!0&&!o&&(a===n?a=-n:a=a-n);const s=this.aStartAngle+e*a;let l=this.aX+this.xRadius*Math.cos(s),c=this.aY+this.yRadius*Math.sin(s);if(this.aRotation!==0){const u=Math.cos(this.aRotation),h=Math.sin(this.aRotation),p=l-this.aX,f=c-this.aY;l=p*u-f*h+this.aX,c=p*h+f*u+this.aY}return r.set(l,c)}copy(e){return super.copy(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}toJSON(){const e=super.toJSON();return e.aX=this.aX,e.aY=this.aY,e.xRadius=this.xRadius,e.yRadius=this.yRadius,e.aStartAngle=this.aStartAngle,e.aEndAngle=this.aEndAngle,e.aClockwise=this.aClockwise,e.aRotation=this.aRotation,e}fromJSON(e){return super.fromJSON(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}}class wf extends Ia{constructor(e,t,r,n,a,o){super(e,t,r,r,n,a,o),this.isArcCurve=!0,this.type="ArcCurve"}}function Oa(){let i=0,e=0,t=0,r=0;function n(a,o,s,l){i=a,e=s,t=-3*a+3*o-2*s-l,r=2*a-2*o+s+l}return{initCatmullRom:function(a,o,s,l,c){n(o,s,c*(s-a),c*(l-o))},initNonuniformCatmullRom:function(a,o,s,l,c,u,h){let p=(o-a)/c-(s-a)/(c+u)+(s-o)/u,f=(s-o)/u-(l-o)/(u+h)+(l-s)/h;p*=u,f*=u,n(o,s,p,f)},calc:function(a){const o=a*a,s=o*a;return i+e*a+t*o+r*s}}}const an=new C,aa=new Oa,sa=new Oa,oa=new Oa;class Af extends Kt{constructor(e=[],t=!1,r="centripetal",n=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=e,this.closed=t,this.curveType=r,this.tension=n}getPoint(e,t=new C){const r=t,n=this.points,a=n.length,o=(a-(this.closed?0:1))*e;let s=Math.floor(o),l=o-s;this.closed?s+=s>0?0:(Math.floor(Math.abs(s)/a)+1)*a:l===0&&s===a-1&&(s=a-2,l=1);let c,u;this.closed||s>0?c=n[(s-1)%a]:(an.subVectors(n[0],n[1]).add(n[0]),c=an);const h=n[s%a],p=n[(s+1)%a];if(this.closed||s+2<a?u=n[(s+2)%a]:(an.subVectors(n[a-1],n[a-2]).add(n[a-1]),u=an),this.curveType==="centripetal"||this.curveType==="chordal"){const f=this.curveType==="chordal"?.5:.25;let g=Math.pow(c.distanceToSquared(h),f),_=Math.pow(h.distanceToSquared(p),f),m=Math.pow(p.distanceToSquared(u),f);_<1e-4&&(_=1),g<1e-4&&(g=_),m<1e-4&&(m=_),aa.initNonuniformCatmullRom(c.x,h.x,p.x,u.x,g,_,m),sa.initNonuniformCatmullRom(c.y,h.y,p.y,u.y,g,_,m),oa.initNonuniformCatmullRom(c.z,h.z,p.z,u.z,g,_,m)}else this.curveType==="catmullrom"&&(aa.initCatmullRom(c.x,h.x,p.x,u.x,this.tension),sa.initCatmullRom(c.y,h.y,p.y,u.y,this.tension),oa.initCatmullRom(c.z,h.z,p.z,u.z,this.tension));return r.set(aa.calc(l),sa.calc(l),oa.calc(l)),r}copy(e){super.copy(e),this.points=[];for(let t=0,r=e.points.length;t<r;t++){const n=e.points[t];this.points.push(n.clone())}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,r=this.points.length;t<r;t++){const n=this.points[t];e.points.push(n.toArray())}return e.closed=this.closed,e.curveType=this.curveType,e.tension=this.tension,e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,r=e.points.length;t<r;t++){const n=e.points[t];this.points.push(new C().fromArray(n))}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}}function mo(i,e,t,r,n){const a=(r-e)*.5,o=(n-t)*.5,s=i*i,l=i*s;return(2*t-2*r+a+o)*l+(-3*t+3*r-2*a-o)*s+a*i+t}function Rf(i,e){const t=1-i;return t*t*e}function Cf(i,e){return 2*(1-i)*i*e}function Pf(i,e){return i*i*e}function yi(i,e,t,r){return Rf(i,e)+Cf(i,t)+Pf(i,r)}function Lf(i,e){const t=1-i;return t*t*t*e}function Df(i,e){const t=1-i;return 3*t*t*i*e}function Uf(i,e){return 3*(1-i)*i*i*e}function Nf(i,e){return i*i*i*e}function Mi(i,e,t,r,n){return Lf(i,e)+Df(i,t)+Uf(i,r)+Nf(i,n)}class nl extends Kt{constructor(e=new he,t=new he,r=new he,n=new he){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=e,this.v1=t,this.v2=r,this.v3=n}getPoint(e,t=new he){const r=t,n=this.v0,a=this.v1,o=this.v2,s=this.v3;return r.set(Mi(e,n.x,a.x,o.x,s.x),Mi(e,n.y,a.y,o.y,s.y)),r}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class If extends Kt{constructor(e=new C,t=new C,r=new C,n=new C){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=e,this.v1=t,this.v2=r,this.v3=n}getPoint(e,t=new C){const r=t,n=this.v0,a=this.v1,o=this.v2,s=this.v3;return r.set(Mi(e,n.x,a.x,o.x,s.x),Mi(e,n.y,a.y,o.y,s.y),Mi(e,n.z,a.z,o.z,s.z)),r}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class al extends Kt{constructor(e=new he,t=new he){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=e,this.v2=t}getPoint(e,t=new he){const r=t;return e===1?r.copy(this.v2):(r.copy(this.v2).sub(this.v1),r.multiplyScalar(e).add(this.v1)),r}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new he){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Of extends Kt{constructor(e=new C,t=new C){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=e,this.v2=t}getPoint(e,t=new C){const r=t;return e===1?r.copy(this.v2):(r.copy(this.v2).sub(this.v1),r.multiplyScalar(e).add(this.v1)),r}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new C){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class sl extends Kt{constructor(e=new he,t=new he,r=new he){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=e,this.v1=t,this.v2=r}getPoint(e,t=new he){const r=t,n=this.v0,a=this.v1,o=this.v2;return r.set(yi(e,n.x,a.x,o.x),yi(e,n.y,a.y,o.y)),r}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Ff extends Kt{constructor(e=new C,t=new C,r=new C){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=e,this.v1=t,this.v2=r}getPoint(e,t=new C){const r=t,n=this.v0,a=this.v1,o=this.v2;return r.set(yi(e,n.x,a.x,o.x),yi(e,n.y,a.y,o.y),yi(e,n.z,a.z,o.z)),r}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class ol extends Kt{constructor(e=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=e}getPoint(e,t=new he){const r=t,n=this.points,a=(n.length-1)*e,o=Math.floor(a),s=a-o,l=n[o===0?o:o-1],c=n[o],u=n[o>n.length-2?n.length-1:o+1],h=n[o>n.length-3?n.length-1:o+2];return r.set(mo(s,l.x,c.x,u.x,h.x),mo(s,l.y,c.y,u.y,h.y)),r}copy(e){super.copy(e),this.points=[];for(let t=0,r=e.points.length;t<r;t++){const n=e.points[t];this.points.push(n.clone())}return this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,r=this.points.length;t<r;t++){const n=this.points[t];e.points.push(n.toArray())}return e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,r=e.points.length;t<r;t++){const n=e.points[t];this.points.push(new he().fromArray(n))}return this}}var go=Object.freeze({__proto__:null,ArcCurve:wf,CatmullRomCurve3:Af,CubicBezierCurve:nl,CubicBezierCurve3:If,EllipseCurve:Ia,LineCurve:al,LineCurve3:Of,QuadraticBezierCurve:sl,QuadraticBezierCurve3:Ff,SplineCurve:ol});class Bf extends Kt{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(e){this.curves.push(e)}closePath(){const e=this.curves[0].getPoint(0),t=this.curves[this.curves.length-1].getPoint(1);if(!e.equals(t)){const r=e.isVector2===!0?"LineCurve":"LineCurve3";this.curves.push(new go[r](t,e))}return this}getPoint(e,t){const r=e*this.getLength(),n=this.getCurveLengths();let a=0;for(;a<n.length;){if(n[a]>=r){const o=n[a]-r,s=this.curves[a],l=s.getLength(),c=l===0?0:1-o/l;return s.getPointAt(c,t)}a++}return null}getLength(){const e=this.getCurveLengths();return e[e.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;const e=[];let t=0;for(let r=0,n=this.curves.length;r<n;r++)t+=this.curves[r].getLength(),e.push(t);return this.cacheLengths=e,e}getSpacedPoints(e=40){const t=[];for(let r=0;r<=e;r++)t.push(this.getPoint(r/e));return this.autoClose&&t.push(t[0]),t}getPoints(e=12){const t=[];let r;for(let n=0,a=this.curves;n<a.length;n++){const o=a[n],s=o.isEllipseCurve?e*2:o.isLineCurve||o.isLineCurve3?1:o.isSplineCurve?e*o.points.length:e,l=o.getPoints(s);for(let c=0;c<l.length;c++){const u=l[c];r&&r.equals(u)||(t.push(u),r=u)}}return this.autoClose&&t.length>1&&!t[t.length-1].equals(t[0])&&t.push(t[0]),t}copy(e){super.copy(e),this.curves=[];for(let t=0,r=e.curves.length;t<r;t++){const n=e.curves[t];this.curves.push(n.clone())}return this.autoClose=e.autoClose,this}toJSON(){const e=super.toJSON();e.autoClose=this.autoClose,e.curves=[];for(let t=0,r=this.curves.length;t<r;t++){const n=this.curves[t];e.curves.push(n.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.autoClose=e.autoClose,this.curves=[];for(let t=0,r=e.curves.length;t<r;t++){const n=e.curves[t];this.curves.push(new go[n.type]().fromJSON(n))}return this}}class _o extends Bf{constructor(e){super(),this.type="Path",this.currentPoint=new he,e&&this.setFromPoints(e)}setFromPoints(e){this.moveTo(e[0].x,e[0].y);for(let t=1,r=e.length;t<r;t++)this.lineTo(e[t].x,e[t].y);return this}moveTo(e,t){return this.currentPoint.set(e,t),this}lineTo(e,t){const r=new al(this.currentPoint.clone(),new he(e,t));return this.curves.push(r),this.currentPoint.set(e,t),this}quadraticCurveTo(e,t,r,n){const a=new sl(this.currentPoint.clone(),new he(e,t),new he(r,n));return this.curves.push(a),this.currentPoint.set(r,n),this}bezierCurveTo(e,t,r,n,a,o){const s=new nl(this.currentPoint.clone(),new he(e,t),new he(r,n),new he(a,o));return this.curves.push(s),this.currentPoint.set(a,o),this}splineThru(e){const t=[this.currentPoint.clone()].concat(e),r=new ol(t);return this.curves.push(r),this.currentPoint.copy(e[e.length-1]),this}arc(e,t,r,n,a,o){const s=this.currentPoint.x,l=this.currentPoint.y;return this.absarc(e+s,t+l,r,n,a,o),this}absarc(e,t,r,n,a,o){return this.absellipse(e,t,r,r,n,a,o),this}ellipse(e,t,r,n,a,o,s,l){const c=this.currentPoint.x,u=this.currentPoint.y;return this.absellipse(e+c,t+u,r,n,a,o,s,l),this}absellipse(e,t,r,n,a,o,s,l){const c=new Ia(e,t,r,n,a,o,s,l);if(this.curves.length>0){const h=c.getPoint(0);h.equals(this.currentPoint)||this.lineTo(h.x,h.y)}this.curves.push(c);const u=c.getPoint(1);return this.currentPoint.copy(u),this}copy(e){return super.copy(e),this.currentPoint.copy(e.currentPoint),this}toJSON(){const e=super.toJSON();return e.currentPoint=this.currentPoint.toArray(),e}fromJSON(e){return super.fromJSON(e),this.currentPoint.fromArray(e.currentPoint),this}}class Nr extends Dt{constructor(e=1,t=1,r=1,n=32,a=1,o=!1,s=0,l=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:e,radiusBottom:t,height:r,radialSegments:n,heightSegments:a,openEnded:o,thetaStart:s,thetaLength:l};const c=this;n=Math.floor(n),a=Math.floor(a);const u=[],h=[],p=[],f=[];let g=0;const _=[],m=r/2;let d=0;E(),o===!1&&(e>0&&v(!0),t>0&&v(!1)),this.setIndex(u),this.setAttribute("position",new xt(h,3)),this.setAttribute("normal",new xt(p,3)),this.setAttribute("uv",new xt(f,2));function E(){const T=new C,w=new C;let A=0;const L=(t-e)/r;for(let V=0;V<=a;V++){const y=[],b=V/a,G=b*(t-e)+e;for(let H=0;H<=n;H++){const q=H/n,P=q*l+s,z=Math.sin(P),X=Math.cos(P);w.x=G*z,w.y=-b*r+m,w.z=G*X,h.push(w.x,w.y,w.z),T.set(z,L,X).normalize(),p.push(T.x,T.y,T.z),f.push(q,1-b),y.push(g++)}_.push(y)}for(let V=0;V<n;V++)for(let y=0;y<a;y++){const b=_[y][V],G=_[y+1][V],H=_[y+1][V+1],q=_[y][V+1];u.push(b,G,q),u.push(G,H,q),A+=6}c.addGroup(d,A,0),d+=A}function v(T){const w=g,A=new he,L=new C;let V=0;const y=T===!0?e:t,b=T===!0?1:-1;for(let H=1;H<=n;H++)h.push(0,m*b,0),p.push(0,b,0),f.push(.5,.5),g++;const G=g;for(let H=0;H<=n;H++){const q=H/n*l+s,P=Math.cos(q),z=Math.sin(q);L.x=y*z,L.y=m*b,L.z=y*P,h.push(L.x,L.y,L.z),p.push(0,b,0),A.x=P*.5+.5,A.y=z*.5*b+.5,f.push(A.x,A.y),g++}for(let H=0;H<n;H++){const q=w+H,P=G+H;T===!0?u.push(P,P+1,q):u.push(P+1,P,q),V+=3}c.addGroup(d,V,T===!0?1:2),d+=V}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Nr(e.radiusTop,e.radiusBottom,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class Fa extends Nr{constructor(e=1,t=1,r=32,n=1,a=!1,o=0,s=Math.PI*2){super(0,e,t,r,n,a,o,s),this.type="ConeGeometry",this.parameters={radius:e,height:t,radialSegments:r,heightSegments:n,openEnded:a,thetaStart:o,thetaLength:s}}static fromJSON(e){return new Fa(e.radius,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class ya extends _o{constructor(e){super(e),this.uuid=oi(),this.type="Shape",this.holes=[]}getPointsHoles(e){const t=[];for(let r=0,n=this.holes.length;r<n;r++)t[r]=this.holes[r].getPoints(e);return t}extractPoints(e){return{shape:this.getPoints(e),holes:this.getPointsHoles(e)}}copy(e){super.copy(e),this.holes=[];for(let t=0,r=e.holes.length;t<r;t++){const n=e.holes[t];this.holes.push(n.clone())}return this}toJSON(){const e=super.toJSON();e.uuid=this.uuid,e.holes=[];for(let t=0,r=this.holes.length;t<r;t++){const n=this.holes[t];e.holes.push(n.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.uuid=e.uuid,this.holes=[];for(let t=0,r=e.holes.length;t<r;t++){const n=e.holes[t];this.holes.push(new _o().fromJSON(n))}return this}}const zf={triangulate:function(i,e,t=2){const r=e&&e.length,n=r?e[0]*t:i.length;let a=ll(i,0,n,t,!0);const o=[];if(!a||a.next===a.prev)return o;let s,l,c,u,h,p,f;if(r&&(a=Wf(i,e,a,t)),i.length>80*t){s=c=i[0],l=u=i[1];for(let g=t;g<n;g+=t)h=i[g],p=i[g+1],h<s&&(s=h),p<l&&(l=p),h>c&&(c=h),p>u&&(u=p);f=Math.max(c-s,u-l),f=f!==0?32767/f:0}return wi(a,o,t,s,l,f,0),o}};function ll(i,e,t,r,n){let a,o;if(n===tm(i,e,t,r)>0)for(a=e;a<t;a+=r)o=vo(a,i[a],i[a+1],o);else for(a=t-r;a>=e;a-=r)o=vo(a,i[a],i[a+1],o);return o&&Sn(o,o.next)&&(Ri(o),o=o.next),o}function Ur(i,e){if(!i)return i;e||(e=i);let t=i,r;do if(r=!1,!t.steiner&&(Sn(t,t.next)||Qe(t.prev,t,t.next)===0)){if(Ri(t),t=e=t.prev,t===t.next)break;r=!0}else t=t.next;while(r||t!==e);return e}function wi(i,e,t,r,n,a,o){if(!i)return;!o&&a&&Kf(i,r,n,a);let s=i,l,c;for(;i.prev!==i.next;){if(l=i.prev,c=i.next,a?Gf(i,r,n,a):Hf(i)){e.push(l.i/t|0),e.push(i.i/t|0),e.push(c.i/t|0),Ri(i),i=c.next,s=c.next;continue}if(i=c,i===s){o?o===1?(i=Vf(Ur(i),e,t),wi(i,e,t,r,n,a,2)):o===2&&kf(i,e,t,r,n,a):wi(Ur(i),e,t,r,n,a,1);break}}}function Hf(i){const e=i.prev,t=i,r=i.next;if(Qe(e,t,r)>=0)return!1;const n=e.x,a=t.x,o=r.x,s=e.y,l=t.y,c=r.y,u=n<a?n<o?n:o:a<o?a:o,h=s<l?s<c?s:c:l<c?l:c,p=n>a?n>o?n:o:a>o?a:o,f=s>l?s>c?s:c:l>c?l:c;let g=r.next;for(;g!==e;){if(g.x>=u&&g.x<=p&&g.y>=h&&g.y<=f&&Qr(n,s,a,l,o,c,g.x,g.y)&&Qe(g.prev,g,g.next)>=0)return!1;g=g.next}return!0}function Gf(i,e,t,r){const n=i.prev,a=i,o=i.next;if(Qe(n,a,o)>=0)return!1;const s=n.x,l=a.x,c=o.x,u=n.y,h=a.y,p=o.y,f=s<l?s<c?s:c:l<c?l:c,g=u<h?u<p?u:p:h<p?h:p,_=s>l?s>c?s:c:l>c?l:c,m=u>h?u>p?u:p:h>p?h:p,d=Ma(f,g,e,t,r),E=Ma(_,m,e,t,r);let v=i.prevZ,T=i.nextZ;for(;v&&v.z>=d&&T&&T.z<=E;){if(v.x>=f&&v.x<=_&&v.y>=g&&v.y<=m&&v!==n&&v!==o&&Qr(s,u,l,h,c,p,v.x,v.y)&&Qe(v.prev,v,v.next)>=0||(v=v.prevZ,T.x>=f&&T.x<=_&&T.y>=g&&T.y<=m&&T!==n&&T!==o&&Qr(s,u,l,h,c,p,T.x,T.y)&&Qe(T.prev,T,T.next)>=0))return!1;T=T.nextZ}for(;v&&v.z>=d;){if(v.x>=f&&v.x<=_&&v.y>=g&&v.y<=m&&v!==n&&v!==o&&Qr(s,u,l,h,c,p,v.x,v.y)&&Qe(v.prev,v,v.next)>=0)return!1;v=v.prevZ}for(;T&&T.z<=E;){if(T.x>=f&&T.x<=_&&T.y>=g&&T.y<=m&&T!==n&&T!==o&&Qr(s,u,l,h,c,p,T.x,T.y)&&Qe(T.prev,T,T.next)>=0)return!1;T=T.nextZ}return!0}function Vf(i,e,t){let r=i;do{const n=r.prev,a=r.next.next;!Sn(n,a)&&cl(n,r,r.next,a)&&Ai(n,a)&&Ai(a,n)&&(e.push(n.i/t|0),e.push(r.i/t|0),e.push(a.i/t|0),Ri(r),Ri(r.next),r=i=a),r=r.next}while(r!==i);return Ur(r)}function kf(i,e,t,r,n,a){let o=i;do{let s=o.next.next;for(;s!==o.prev;){if(o.i!==s.i&&Qf(o,s)){let l=ul(o,s);o=Ur(o,o.next),l=Ur(l,l.next),wi(o,e,t,r,n,a,0),wi(l,e,t,r,n,a,0);return}s=s.next}o=o.next}while(o!==i)}function Wf(i,e,t,r){const n=[];let a,o,s,l,c;for(a=0,o=e.length;a<o;a++)s=e[a]*r,l=a<o-1?e[a+1]*r:i.length,c=ll(i,s,l,r,!1),c===c.next&&(c.steiner=!0),n.push(Zf(c));for(n.sort(Xf),a=0;a<n.length;a++)t=jf(n[a],t);return t}function Xf(i,e){return i.x-e.x}function jf(i,e){const t=qf(i,e);if(!t)return e;const r=ul(t,i);return Ur(r,r.next),Ur(t,t.next)}function qf(i,e){let t=e,r=-1/0,n;const a=i.x,o=i.y;do{if(o<=t.y&&o>=t.next.y&&t.next.y!==t.y){const p=t.x+(o-t.y)*(t.next.x-t.x)/(t.next.y-t.y);if(p<=a&&p>r&&(r=p,n=t.x<t.next.x?t:t.next,p===a))return n}t=t.next}while(t!==e);if(!n)return null;const s=n,l=n.x,c=n.y;let u=1/0,h;t=n;do a>=t.x&&t.x>=l&&a!==t.x&&Qr(o<c?a:r,o,l,c,o<c?r:a,o,t.x,t.y)&&(h=Math.abs(o-t.y)/(a-t.x),Ai(t,i)&&(h<u||h===u&&(t.x>n.x||t.x===n.x&&Yf(n,t)))&&(n=t,u=h)),t=t.next;while(t!==s);return n}function Yf(i,e){return Qe(i.prev,i,e.prev)<0&&Qe(e.next,i,i.next)<0}function Kf(i,e,t,r){let n=i;do n.z===0&&(n.z=Ma(n.x,n.y,e,t,r)),n.prevZ=n.prev,n.nextZ=n.next,n=n.next;while(n!==i);n.prevZ.nextZ=null,n.prevZ=null,Jf(n)}function Jf(i){let e,t,r,n,a,o,s,l,c=1;do{for(t=i,i=null,a=null,o=0;t;){for(o++,r=t,s=0,e=0;e<c&&(s++,r=r.nextZ,!!r);e++);for(l=c;s>0||l>0&&r;)s!==0&&(l===0||!r||t.z<=r.z)?(n=t,t=t.nextZ,s--):(n=r,r=r.nextZ,l--),a?a.nextZ=n:i=n,n.prevZ=a,a=n;t=r}a.nextZ=null,c*=2}while(o>1);return i}function Ma(i,e,t,r,n){return i=(i-t)*n|0,e=(e-r)*n|0,i=(i|i<<8)&16711935,i=(i|i<<4)&252645135,i=(i|i<<2)&858993459,i=(i|i<<1)&1431655765,e=(e|e<<8)&16711935,e=(e|e<<4)&252645135,e=(e|e<<2)&858993459,e=(e|e<<1)&1431655765,i|e<<1}function Zf(i){let e=i,t=i;do(e.x<t.x||e.x===t.x&&e.y<t.y)&&(t=e),e=e.next;while(e!==i);return t}function Qr(i,e,t,r,n,a,o,s){return(n-o)*(e-s)>=(i-o)*(a-s)&&(i-o)*(r-s)>=(t-o)*(e-s)&&(t-o)*(a-s)>=(n-o)*(r-s)}function Qf(i,e){return i.next.i!==e.i&&i.prev.i!==e.i&&!$f(i,e)&&(Ai(i,e)&&Ai(e,i)&&em(i,e)&&(Qe(i.prev,i,e.prev)||Qe(i,e.prev,e))||Sn(i,e)&&Qe(i.prev,i,i.next)>0&&Qe(e.prev,e,e.next)>0)}function Qe(i,e,t){return(e.y-i.y)*(t.x-e.x)-(e.x-i.x)*(t.y-e.y)}function Sn(i,e){return i.x===e.x&&i.y===e.y}function cl(i,e,t,r){const n=on(Qe(i,e,t)),a=on(Qe(i,e,r)),o=on(Qe(t,r,i)),s=on(Qe(t,r,e));return!!(n!==a&&o!==s||n===0&&sn(i,t,e)||a===0&&sn(i,r,e)||o===0&&sn(t,i,r)||s===0&&sn(t,e,r))}function sn(i,e,t){return e.x<=Math.max(i.x,t.x)&&e.x>=Math.min(i.x,t.x)&&e.y<=Math.max(i.y,t.y)&&e.y>=Math.min(i.y,t.y)}function on(i){return i>0?1:i<0?-1:0}function $f(i,e){let t=i;do{if(t.i!==i.i&&t.next.i!==i.i&&t.i!==e.i&&t.next.i!==e.i&&cl(t,t.next,i,e))return!0;t=t.next}while(t!==i);return!1}function Ai(i,e){return Qe(i.prev,i,i.next)<0?Qe(i,e,i.next)>=0&&Qe(i,i.prev,e)>=0:Qe(i,e,i.prev)<0||Qe(i,i.next,e)<0}function em(i,e){let t=i,r=!1;const n=(i.x+e.x)/2,a=(i.y+e.y)/2;do t.y>a!=t.next.y>a&&t.next.y!==t.y&&n<(t.next.x-t.x)*(a-t.y)/(t.next.y-t.y)+t.x&&(r=!r),t=t.next;while(t!==i);return r}function ul(i,e){const t=new Sa(i.i,i.x,i.y),r=new Sa(e.i,e.x,e.y),n=i.next,a=e.prev;return i.next=e,e.prev=i,t.next=n,n.prev=t,r.next=t,t.prev=r,a.next=r,r.prev=a,r}function vo(i,e,t,r){const n=new Sa(i,e,t);return r?(n.next=r.next,n.prev=r,r.next.prev=n,r.next=n):(n.prev=n,n.next=n),n}function Ri(i){i.next.prev=i.prev,i.prev.next=i.next,i.prevZ&&(i.prevZ.nextZ=i.nextZ),i.nextZ&&(i.nextZ.prevZ=i.prevZ)}function Sa(i,e,t){this.i=i,this.x=e,this.y=t,this.prev=null,this.next=null,this.z=0,this.prevZ=null,this.nextZ=null,this.steiner=!1}function tm(i,e,t,r){let n=0;for(let a=e,o=t-r;a<t;a+=r)n+=(i[o]-i[a])*(i[a+1]+i[o+1]),o=a;return n}class Si{static area(e){const t=e.length;let r=0;for(let n=t-1,a=0;a<t;n=a++)r+=e[n].x*e[a].y-e[a].x*e[n].y;return r*.5}static isClockWise(e){return Si.area(e)<0}static triangulateShape(e,t){const r=[],n=[],a=[];xo(e),yo(r,e);let o=e.length;t.forEach(xo);for(let l=0;l<t.length;l++)n.push(o),o+=t[l].length,yo(r,t[l]);const s=zf.triangulate(r,n);for(let l=0;l<s.length;l+=3)a.push(s.slice(l,l+3));return a}}function xo(i){const e=i.length;e>2&&i[e-1].equals(i[0])&&i.pop()}function yo(i,e){for(let t=0;t<e.length;t++)i.push(e[t].x),i.push(e[t].y)}class Ba extends Dt{constructor(e=new ya([new he(0,.5),new he(-.5,-.5),new he(.5,-.5)]),t=12){super(),this.type="ShapeGeometry",this.parameters={shapes:e,curveSegments:t};const r=[],n=[],a=[],o=[];let s=0,l=0;if(Array.isArray(e)===!1)c(e);else for(let u=0;u<e.length;u++)c(e[u]),this.addGroup(s,l,u),s+=l,l=0;this.setIndex(r),this.setAttribute("position",new xt(n,3)),this.setAttribute("normal",new xt(a,3)),this.setAttribute("uv",new xt(o,2));function c(u){const h=n.length/3,p=u.extractPoints(t);let f=p.shape;const g=p.holes;Si.isClockWise(f)===!1&&(f=f.reverse());for(let m=0,d=g.length;m<d;m++){const E=g[m];Si.isClockWise(E)===!0&&(g[m]=E.reverse())}const _=Si.triangulateShape(f,g);for(let m=0,d=g.length;m<d;m++){const E=g[m];f=f.concat(E)}for(let m=0,d=f.length;m<d;m++){const E=f[m];n.push(E.x,E.y,0),a.push(0,0,1),o.push(E.x,E.y)}for(let m=0,d=_.length;m<d;m++){const E=_[m],v=E[0]+h,T=E[1]+h,w=E[2]+h;r.push(v,T,w),l+=3}}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}toJSON(){const e=super.toJSON(),t=this.parameters.shapes;return rm(t,e)}static fromJSON(e,t){const r=[];for(let n=0,a=e.shapes.length;n<a;n++){const o=t[e.shapes[n]];r.push(o)}return new Ba(r,e.curveSegments)}}function rm(i,e){if(e.shapes=[],Array.isArray(i))for(let t=0,r=i.length;t<r;t++){const n=i[t];e.shapes.push(n.uuid)}else e.shapes.push(i.uuid);return e}class za extends Dt{constructor(e=1,t=32,r=16,n=0,a=Math.PI*2,o=0,s=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:t,heightSegments:r,phiStart:n,phiLength:a,thetaStart:o,thetaLength:s},t=Math.max(3,Math.floor(t)),r=Math.max(2,Math.floor(r));const l=Math.min(o+s,Math.PI);let c=0;const u=[],h=new C,p=new C,f=[],g=[],_=[],m=[];for(let d=0;d<=r;d++){const E=[],v=d/r;let T=0;d===0&&o===0?T=.5/t:d===r&&l===Math.PI&&(T=-.5/t);for(let w=0;w<=t;w++){const A=w/t;h.x=-e*Math.cos(n+A*a)*Math.sin(o+v*s),h.y=e*Math.cos(o+v*s),h.z=e*Math.sin(n+A*a)*Math.sin(o+v*s),g.push(h.x,h.y,h.z),p.copy(h).normalize(),_.push(p.x,p.y,p.z),m.push(A+T,1-v),E.push(c++)}u.push(E)}for(let d=0;d<r;d++)for(let E=0;E<t;E++){const v=u[d][E+1],T=u[d][E],w=u[d+1][E],A=u[d+1][E+1];(d!==0||o>0)&&f.push(v,T,A),(d!==r-1||l<Math.PI)&&f.push(T,w,A)}this.setIndex(f),this.setAttribute("position",new xt(g,3)),this.setAttribute("normal",new xt(_,3)),this.setAttribute("uv",new xt(m,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new za(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class et extends li{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new Ve(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ve(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=Oo,this.normalScale=new he(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class hl extends pt{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new Ve(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),t}}const la=new tt,Mo=new C,So=new C;class im{constructor(e){this.camera=e,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new he(512,512),this.map=null,this.mapPass=null,this.matrix=new tt,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Da,this._frameExtents=new he(1,1),this._viewportCount=1,this._viewports=[new ct(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,r=this.matrix;Mo.setFromMatrixPosition(e.matrixWorld),t.position.copy(Mo),So.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(So),t.updateMatrixWorld(),la.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(la),r.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),r.multiply(la)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class nm extends im{constructor(){super(new Ko(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class am extends hl{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(pt.DEFAULT_UP),this.updateMatrix(),this.target=new pt,this.shadow=new nm}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class sm extends hl{constructor(e,t){super(e,t),this.isAmbientLight=!0,this.type="AmbientLight"}}class om{constructor(e,t,r=0,n=1/0){this.ray=new Ca(e,t),this.near=r,this.far=n,this.camera=null,this.layers=new Pa,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(e,t){this.ray.set(e,t)}setFromCamera(e,t){t.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(t.matrixWorld),this.ray.direction.set(e.x,e.y,.5).unproject(t).sub(this.ray.origin).normalize(),this.camera=t):t.isOrthographicCamera?(this.ray.origin.set(e.x,e.y,(t.near+t.far)/(t.near-t.far)).unproject(t),this.ray.direction.set(0,0,-1).transformDirection(t.matrixWorld),this.camera=t):console.error("THREE.Raycaster: Unsupported camera type: "+t.type)}intersectObject(e,t=!0,r=[]){return Ea(e,this,r,t),r.sort(Eo),r}intersectObjects(e,t=!0,r=[]){for(let n=0,a=e.length;n<a;n++)Ea(e[n],this,r,t);return r.sort(Eo),r}}function Eo(i,e){return i.distance-e.distance}function Ea(i,e,t,r){if(i.layers.test(e.layers)&&i.raycast(e,t),r===!0){const n=i.children;for(let a=0,o=n.length;a<o;a++)Ea(n[a],e,t,!0)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:wa}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=wa);function lm(i){const e=new wt;i.add(e);const t=new ci(200,200),r=new et({color:3509287,roughness:.8,metalness:.2}),n=new Ge(t,r);n.rotation.x=-Math.PI/2,n.receiveShadow=!0,e.add(n);const a=cm();e.add(a);const{outerBoundary:o,innerBoundary:s}=dm();e.add(o),e.add(s);const l=pm();e.add(l);const c=hm();e.add(c);const u=fm();e.add(u);const h=mm();return e.add(h),gm(e),e.userData={path:a,outerBoundary:o,innerBoundary:s,checkpoints:l,startGate:c,powerups:u,jumps:h,checkpointStates:new Array(l.children.length).fill(!1),startLine:{position:new C(20,0,0),direction:new C(0,0,1)},lastCheckpointPassed:-1},console.log("Track created with boundaries:",{outerBoundary:o.geometry.parameters,innerBoundary:s.geometry.parameters}),e}function cm(){const i=new wt,e=new ya,t=[{x:20,y:0},{x:40,y:10},{x:50,y:30},{x:40,y:50},{x:20,y:60},{x:0,y:50},{x:-20,y:30},{x:-30,y:0},{x:-20,y:-30},{x:0,y:-40},{x:20,y:-20}];e.moveTo(t[0].x,t[0].y);for(let l=1;l<t.length;l++){const c=t[l-1],u=t[l],h=t[(l+1)%t.length],p={x:c.x+(u.x-c.x)*.5,y:c.y+(u.y-c.y)*.5},f={x:u.x+(h.x-u.x)*.5,y:u.y+(h.y-u.y)*.5};e.bezierCurveTo(p.x,p.y,f.x,f.y,h.x,h.y)}const r=new ya,n=.7;r.moveTo(t[0].x*n,t[0].y*n);for(let l=1;l<t.length;l++){const c=t[l-1],u=t[l],h=t[(l+1)%t.length],p={x:(c.x+(u.x-c.x)*.5)*n,y:(c.y+(u.y-c.y)*.5)*n},f={x:(u.x+(h.x-u.x)*.5)*n,y:(u.y+(h.y-u.y)*.5)*n};r.bezierCurveTo(p.x,p.y,f.x,f.y,h.x*n,h.y*n)}e.holes.push(r);const a=new Ba(e),o=new et({color:3355443,roughness:.7,metalness:.1}),s=new Ge(a,o);return s.rotation.x=-Math.PI/2,s.position.y=.01,s.receiveShadow=!0,i.add(s),um(i,t),i}function um(i,e){const t=new ci(10,1),r=new et({color:16777215,roughness:.5,metalness:.2}),n=new Ge(t,r);n.rotation.x=-Math.PI/2,n.position.set(20,.02,0),n.rotation.z=Math.PI/2,n.receiveShadow=!0,i.add(n);const a=[],o=100;for(let u=0;u<o;u++)if(u%2===0){const h=u/o,p=Math.floor(h*e.length),f=(p+1)%e.length,g=e[p],_=e[f],m=g.x+(_.x-g.x)*(h*e.length-p),d=g.y+(_.y-g.y)*(h*e.length-p);a.push(new C(m,.02,d))}const s=new Dt().setFromPoints(a),l=new Na({color:16777215,size:.3}),c=new il(s,l);i.add(c)}function hm(){const i=new wt,e=new at(.5,5,.5),t=new et({color:14540253,roughness:.5,metalness:.7}),r=new Ge(e,t);r.position.set(20,2.5,-5),r.castShadow=!0,r.receiveShadow=!0,i.add(r);const n=new Ge(e,t);n.position.set(20,2.5,5),n.castShadow=!0,n.receiveShadow=!0,i.add(n);const a=new at(.5,1,11),o=new et({color:16711680,roughness:.5,metalness:.3}),s=new Ge(a,o);s.position.set(20,5,0),s.castShadow=!0,s.receiveShadow=!0,i.add(s);const l=new at(.1,.6,8),c=new et({color:16777215,roughness:.5,metalness:.3}),u=new Ge(l,c);u.position.set(19.7,5,0),u.castShadow=!0,i.add(u);const h=new at(1,1,.1),p=new et({color:0,roughness:.5,metalness:.3}),f=new Ge(h,p);f.position.set(20,6,-5),f.castShadow=!0,i.add(f);const g=new Ge(h,p);g.position.set(20,6,5),g.castShadow=!0,i.add(g);const _=new ci(1,10),m=new et({color:16777215,roughness:.5,metalness:.2}),d=new Ge(_,m);return d.rotation.x=-Math.PI/2,d.position.set(20,.03,0),d.receiveShadow=!0,i.add(d),i.userData={isGate:!0,collisionBox:new Rt().setFromObject(i)},i}function dm(i){const e=new et({color:16711680,transparent:!0,opacity:.2}),t=new at(150,1,150),r=new Ge(t,e);r.position.y=.5,r.visible=!1;const n=new at(50,1,50),a=new Ge(n,e);return a.position.y=.5,a.visible=!1,{outerBoundary:r,innerBoundary:a}}function pm(){const i=new wt,e=[{x:20,z:0},{x:40,z:10},{x:50,z:30},{x:40,z:50},{x:20,z:60},{x:0,z:50},{x:-20,z:30},{x:-30,z:0},{x:-20,z:-30},{x:0,z:-40},{x:20,z:-20}];return e.forEach((t,r)=>{const n=new at(2,1,10),a=new La({color:65280,transparent:!0,opacity:.3}),o=new Ge(n,a);o.position.set(t.x,.5,t.z);const s=e[(r+1)%e.length],l=new C(s.x-t.x,0,s.z-t.z).normalize(),c=new C(-l.z,0,l.x),u=new C(t.x+c.x,.5,t.z+c.z);o.lookAt(u),o.userData={index:r,isFinishLine:r===0},i.add(o)}),i}function fm(){const i=new wt;return[{x:35,z:20,type:"speedBoost"},{x:30,z:55,type:"shield"},{x:-10,z:40,type:"speedBoost"},{x:-25,z:10,type:"shield"},{x:-10,z:-30,type:"speedBoost"},{x:10,z:-30,type:"shield"}].forEach(e=>{const t=new at(1,1,1),r=new et({color:e.type==="speedBoost"?16711680:255,roughness:.3,metalness:.8,emissive:e.type==="speedBoost"?16711680:255,emissiveIntensity:.5}),n=new Ge(t,r);n.position.set(e.x,1,e.z),n.castShadow=!0,n.userData={type:e.type,rotationSpeed:.02,bounceHeight:.5,bounceSpeed:.01,originalY:1,bounceTime:0,active:!0,respawnTime:0,collisionBox:new Rt().setFromObject(n),update:function(){this.active?(n.rotation.y+=this.rotationSpeed,this.bounceTime+=this.bounceSpeed,n.position.y=this.originalY+Math.sin(this.bounceTime)*this.bounceHeight,this.collisionBox.setFromObject(n)):this.respawnTime>0&&(this.respawnTime-=16.67,this.respawnTime<=0&&(this.active=!0,n.visible=!0))},collect:function(){return this.active?(this.active=!1,n.visible=!1,this.respawnTime=1e4,this.type):null}},i.add(n)}),i}function mm(){const i=new wt;return[{x:45,z:40,rotation:Math.PI/4},{x:-15,z:45,rotation:Math.PI/2},{x:-25,z:-15,rotation:-Math.PI/4}].forEach(e=>{const t=new at(5,1,10),r=new et({color:16763904,roughness:.5,metalness:.3}),n=new Ge(t,r);n.position.set(e.x,.5,e.z),n.rotation.y=e.rotation,n.rotation.x=Math.PI/12,n.castShadow=!0,n.receiveShadow=!0,n.userData={isJump:!0,jumpForce:.8,collisionBox:new Rt().setFromObject(n)},i.add(n)}),i}function gm(i){[{x:30,z:30},{x:50,z:10},{x:60,z:40},{x:30,z:70},{x:10,z:60},{x:-10,z:70},{x:-30,z:50},{x:-50,z:20},{x:-40,z:-10},{x:-30,z:-40},{x:-10,z:-50},{x:20,z:-40},{x:40,z:-20}].forEach(e=>{const t=_m();t.position.set(e.x,0,e.z),t.userData={isObstacle:!0,collisionBox:new Rt().setFromObject(t)},i.add(t)}),[{x:25,z:5,rotation:Math.PI/2},{x:35,z:15,rotation:Math.PI/4},{x:45,z:25,rotation:Math.PI/4},{x:45,z:40,rotation:0},{x:35,z:55,rotation:-Math.PI/4},{x:25,z:65,rotation:-Math.PI/4},{x:10,z:65,rotation:-Math.PI/2},{x:-5,z:60,rotation:-Math.PI*3/4},{x:-15,z:45,rotation:-Math.PI*3/4},{x:-25,z:35,rotation:-Math.PI},{x:-35,z:15,rotation:-Math.PI*5/4},{x:-35,z:0,rotation:-Math.PI*3/2},{x:-30,z:-15,rotation:Math.PI*3/4},{x:-15,z:-35,rotation:Math.PI*3/4},{x:0,z:-45,rotation:Math.PI/2},{x:15,z:-35,rotation:Math.PI/4},{x:25,z:-15,rotation:Math.PI/4}].forEach(e=>{const t=vm();t.position.set(e.x,0,e.z),t.rotation.y=e.rotation,t.userData={isObstacle:!0,collisionBox:new Rt().setFromObject(t)},i.add(t)})}function _m(){const i=new wt,e=new Nr(.5,.7,3,8),t=new et({color:9127187,roughness:.8,metalness:.2}),r=new Ge(e,t);r.position.y=1.5,r.castShadow=!0,r.receiveShadow=!0,i.add(r);const n=new Fa(2,4,8),a=new et({color:2263842,roughness:.8,metalness:.2}),o=new Ge(n,a);return o.position.y=5,o.castShadow=!0,o.receiveShadow=!0,i.add(o),i}function vm(){const i=new wt,e=new Nr(.2,.2,1,8),t=new et({color:8947848,roughness:.5,metalness:.5}),r=new Ge(e,t);r.position.set(-1,.5,0),r.castShadow=!0,r.receiveShadow=!0,i.add(r);const n=new Ge(e,t);n.position.set(1,.5,0),n.castShadow=!0,n.receiveShadow=!0,i.add(n);const a=new at(2.5,.2,.1),o=new et({color:16711680,roughness:.5,metalness:.3}),s=new Ge(a,o);return s.position.y=.7,s.castShadow=!0,s.receiveShadow=!0,i.add(s),i}function dl(i,e=!0,t=16711680){const r=new wt;i.add(r);const n=new at(2,.5,3),a=new et({color:t,roughness:.5,metalness:.5}),o=new Ge(n,a);o.position.y=.5,o.castShadow=!0,o.receiveShadow=!0,r.add(o);const s=new at(1.2,.4,1),l=new et({color:255,roughness:.5,metalness:.5}),c=new Ge(s,l);c.position.set(0,.9,-.2),c.castShadow=!0,c.receiveShadow=!0,r.add(c);const u=new za(.3,16,16),h=new at(.6,.6,.6),p=new et({color:16763904,roughness:.7,metalness:.3}),f=new Ge(u,p);f.position.set(0,1.4,-.2),f.castShadow=!0,r.add(f);const g=new Ge(h,p);g.position.set(0,1,-.2),g.castShadow=!0,r.add(g);const _=xm();_.forEach(V=>r.add(V));const m=new at(1.8,.3,.3),d=new et({color:13421772,roughness:.5,metalness:.7}),E=new Ge(m,d);E.position.set(0,.3,1.5),E.castShadow=!0,E.receiveShadow=!0,r.add(E);const v=new Nr(.1,.1,.5,8),T=new et({color:3355443,roughness:.3,metalness:.8}),w=new Ge(v,T);w.position.set(.5,.5,-1.5),w.rotation.x=Math.PI/2,w.castShadow=!0,r.add(w);const A=new Ge(v,T);A.position.set(-.5,.5,-1.5),A.rotation.x=Math.PI/2,A.castShadow=!0,r.add(A);const L=ym();return r.add(L),r.userData={speed:0,acceleration:0,maxSpeed:80,handling:e?.15:.12,drift:0,jumpForce:0,isJumping:!1,jumpHeight:0,maxJumpHeight:3,gravity:.2,wheels:_,exhaustParticles:L,isPlayer:e,powerups:{speedBoost:!1,speedBoostTime:0,shield:!1,shieldTime:0},collisionBox:new Rt().setFromObject(r)},console.log(`Kart created with handling: ${r.userData.handling}, max speed: ${r.userData.maxSpeed}, and color: ${t.toString(16)}`),r}function xm(){const i=new Nr(.4,.4,.3,16),e=new et({color:3355443,roughness:.7,metalness:.5}),t=[{x:1,y:.4,z:1},{x:-1,y:.4,z:1},{x:1,y:.4,z:-1},{x:-1,y:.4,z:-1}],r=[];return t.forEach(n=>{const a=new Ge(i,e);a.position.set(n.x,n.y,n.z),a.rotation.z=Math.PI/2,a.castShadow=!0,a.receiveShadow=!0,r.push(a)}),r}function ym(){const i=new wt,e=20,t=new Dt,r=new Float32Array(e*3);for(let o=0;o<e;o++){const s=o*3;r[s]=(Math.random()-.5)*.3,r[s+1]=(Math.random()-.5)*.3,r[s+2]=-1.5-Math.random()*2}t.setAttribute("position",new jt(r,3));const n=new Na({color:11184810,size:.1,transparent:!0,opacity:.6}),a=new il(t,n);return a.position.y=.5,i.add(a),i.userData={originalPositions:r.slice(),update:function(){const o=a.geometry.attributes.position.array;for(let s=0;s<e;s++){const l=s*3;o[l+2]-=.1,o[l+2]<-3&&(o[l]=(Math.random()-.5)*.3,o[l+1]=(Math.random()-.5)*.3,o[l+2]=-1.5)}a.geometry.attributes.position.needsUpdate=!0}},i}function Mm(i){console.log("Setting up controls for kart:",i);const e={forward:!1,backward:!1,left:!1,right:!1,drift:!1,jump:!1,usePowerup:!1,canControl:!1},t={KeyW:"forward",ArrowUp:"forward",KeyS:"backward",ArrowDown:"backward",KeyA:"left",ArrowLeft:"left",KeyD:"right",ArrowRight:"right",Space:"drift",ShiftLeft:"jump",ShiftRight:"jump",KeyE:"usePowerup"};window.addEventListener("keydown",a=>{const o=t[a.code];o&&e.canControl&&(e[o]=!0,console.log(`Control ${o} set to true from key ${a.code}`),console.log("Current control state:",{...e}))}),window.addEventListener("keyup",a=>{const o=t[a.code];o&&(e[o]=!1,console.log(`Control ${o} set to false from key ${a.code}`))});function r(){e.canControl=!0,console.log("Controls enabled!")}function n(){const a=i.userData;if(!a.isPlayer)return;if(e.forward&&e.canControl){const c=a.powerups.speedBoost?2:1;a.acceleration=.15*c,console.log("Applying forward acceleration:",a.acceleration)}else e.backward&&e.canControl?(a.acceleration=-.12,console.log("Applying backward acceleration:",a.acceleration)):(a.acceleration=0,a.speed*=.98);let o=0;e.left&&e.canControl?(o=-a.handling,console.log("Turning left, steering value:",o)):e.right&&e.canControl&&(o=a.handling,console.log("Turning right, steering value:",o)),e.drift&&e.canControl?(a.drift=.03,i.rotation.z=o*.5):(a.drift=0,i.rotation.z*=.9),e.jump&&!a.isJumping&&e.canControl&&(a.isJumping=!0,a.jumpForce=.5,console.log("Jump initiated")),a.isJumping&&(a.jumpHeight+=a.jumpForce,a.jumpForce-=a.gravity,i.position.y=.6+a.jumpHeight,a.jumpHeight<=0&&(a.isJumping=!1,a.jumpHeight=0,a.jumpForce=0,i.position.y=.6,console.log("Jump completed"))),e.usePowerup&&e.canControl&&(e.usePowerup=!1,a.powerups.speedBoost&&(console.log("Speed boost activated!"),a.powerups.speedBoostTime=3e3),a.powerups.shield&&(console.log("Shield activated!"),a.powerups.shieldTime=5e3)),a.powerups.speedBoostTime>0&&(a.powerups.speedBoostTime-=16.67,a.powerups.speedBoostTime<=0&&(a.powerups.speedBoost=!1,console.log("Speed boost ended"))),a.powerups.shieldTime>0&&(a.powerups.shieldTime-=16.67,a.powerups.shieldTime<=0&&(a.powerups.shield=!1,console.log("Shield ended")));const s=Math.max(.5,Math.abs(a.speed)/5),l=o*s;i.rotation.y-=l,Math.abs(l)>.001&&(console.log("Applied steering amount:",l),console.log("New kart rotation:",i.rotation.y)),Sm(a.wheels,a.speed,o),Math.abs(a.speed)>.5&&a.exhaustParticles.userData.update(),a.collisionBox.setFromObject(i),(e.forward||e.backward||e.left||e.right)&&console.log("Kart data after update:",{speed:a.speed,acceleration:a.acceleration,steering:o,position:i.position.clone(),rotation:i.rotation.y,isJumping:a.isJumping,jumpHeight:a.jumpHeight})}return{update:n,enableControls:r,getControlState:()=>({...e})}}function Sm(i,e,t){const r=e*.1;i.forEach((n,a)=>{n.rotation.x+=r,a<2&&(n.rotation.y=0,n.rotation.y=t*2)})}function pl(i,e){console.log("Setting up physics for kart:",i);const t={velocity:new C(0,0,0),direction:new C(0,0,-1),isGrounded:!0,isColliding:!1,checkpointsPassed:new Array(e.userData.checkpoints.children.length).fill(!1),lastCheckpoint:-1,lapCompleted:!1,finishLineCrossed:!1,allCheckpointsPassed:!1,collisionCooldown:0};new om;function r(){const h=i.userData;if(console.log("Physics update - Current kart data:",{speed:h.speed,acceleration:h.acceleration,position:i.position.clone()}),h.speed+=h.acceleration,h.speed>h.maxSpeed?h.speed=h.maxSpeed:h.speed<-h.maxSpeed/2&&(h.speed=-h.maxSpeed/2),t.direction.set(0,0,-1).applyQuaternion(i.quaternion),t.velocity.copy(t.direction).multiplyScalar(h.speed),Math.abs(h.speed)>.01&&console.log("Calculated velocity:",t.velocity.clone()),h.drift!==0){const g=new C(-t.direction.z,0,t.direction.x);g.normalize().multiplyScalar(h.drift*h.speed),t.velocity.add(g)}const p=i.position.clone();i.position.add(t.velocity),t.collisionCooldown>0&&(t.collisionCooldown-=16.67);const f=n();f.colliding?(a(f),console.log("Collision detected, bouncing back")):Math.abs(h.speed)>.01&&(console.log("Kart moved from",p,"to",i.position.clone()),console.log("Movement delta:",i.position.clone().sub(p))),o(),s(),l(),t.lapCompleted=!1}function n(){const h={colliding:!1,normal:new C,isObstacle:!1};if(i.userData.powerups.shield)return h;const p=e.userData.outerBoundary,f=e.userData.innerBoundary,g=i.userData.collisionBox,_=new Rt().setFromObject(p);if(!_.containsBox(g)){h.colliding=!0;const d=new C;_.getCenter(d),h.normal.subVectors(i.position,d).normalize(),console.log("Outer boundary collision detected"),console.log("Kart position:",i.position.clone()),console.log("Boundary center:",d)}const m=new Rt().setFromObject(f);if(m.intersectsBox(g)){h.colliding=!0;const d=new C;m.getCenter(d),h.normal.subVectors(i.position,d).normalize(),h.normal.negate(),console.log("Inner boundary collision detected"),console.log("Kart position:",i.position.clone()),console.log("Boundary center:",d)}if(!h.colliding&&t.collisionCooldown<=0){const d=Array.from(e.children).filter(E=>E.userData&&E.userData.isObstacle);for(const E of d)if(E.userData.collisionBox.intersectsBox(g)){h.colliding=!0,h.isObstacle=!0;const v=new C;E.userData.collisionBox.getCenter(v),h.normal.subVectors(i.position,v).normalize(),console.log("Obstacle collision detected"),console.log("Kart position:",i.position.clone()),console.log("Obstacle center:",v);break}}return h}function a(h){const p=h.isObstacle?.8:.5,f=t.velocity.dot(h.normal);t.velocity.sub(h.normal.multiplyScalar(2*f)),i.userData.speed*=p;const g=h.isObstacle?.5:.1;i.position.add(h.normal.clone().multiplyScalar(g)),h.isObstacle&&(t.collisionCooldown=500)}function o(){const h=e.userData.checkpoints.children,p=i.userData.collisionBox;let f=!1;h.forEach((g,_)=>{new Rt().setFromObject(g).intersectsBox(p)&&(g.userData.isFinishLine?(f=!0,console.log("Finish line crossed!")):(t.checkpointsPassed[_]=!0,t.lastCheckpoint=_,console.log(`Checkpoint ${_} passed`),e.userData.lastCheckpointPassed=_))}),t.checkpointsPassed.every(g=>g)&&f&&(t.lapCompleted=!0,console.log("LAP COMPLETED!"),console.log("Checkpoints state:",[...t.checkpointsPassed]),t.checkpointsPassed.fill(!1))}function s(){if(!e.userData.powerups)return;const h=e.userData.powerups.children,p=i.userData.collisionBox;h.forEach(f=>{if(f.userData.active){if(f.userData.collisionBox.intersectsBox(p)){const g=f.userData.collect();g&&(g==="speedBoost"?(i.userData.powerups.speedBoost=!0,i.userData.powerups.speedBoostTime=3e3,console.log("Speed boost collected!")):g==="shield"&&(i.userData.powerups.shield=!0,i.userData.powerups.shieldTime=5e3,console.log("Shield collected!")))}f.userData.update()}})}function l(){if(!e.userData.jumps)return;const h=e.userData.jumps.children,p=i.userData.collisionBox;h.forEach(f=>{f.userData.collisionBox.intersectsBox(p)&&!i.userData.isJumping&&(i.userData.isJumping=!0,i.userData.jumpForce=f.userData.jumpForce,console.log("Jump triggered!"))})}function c(){return i.userData.speed}function u(){return t.lapCompleted}return{update:r,getSpeed:c,checkLapComplete:u,debug:{getPhysicsState:()=>({...t}),applyTestForce:h=>{i.userData.speed=h,console.log("Applied test force:",h)}}}}const He={isPlaying:!1,currentLap:0,totalLaps:3,speed:0,startTime:0,lapTimes:[],raceStartTime:0,totalRaceTime:0,countdownComplete:!1,aiKarts:[]},Em=document.getElementById("speed-meter"),Tm=document.getElementById("lap-counter"),Ta=document.getElementById("game-menu"),bm=document.getElementById("start-button"),_r=new bf;_r.background=new Ve(8900331);const ti=new Bt(75,window.innerWidth/window.innerHeight,.1,1e3);ti.position.set(0,5,10);const hi=new rl({antialias:!0});hi.setSize(window.innerWidth,window.innerHeight);hi.shadowMap.enabled=!0;hi.shadowMap.type=bo;document.body.appendChild(hi.domElement);const wm=new sm(16777215,.5);_r.add(wm);const Li=new am(16777215,.8);Li.position.set(10,20,10);Li.castShadow=!0;Li.shadow.mapSize.width=2048;Li.shadow.mapSize.height=2048;_r.add(Li);let Tt,Ke,mn,Ei,ba=[];function Am(){console.log("Initializing game..."),Tt=lm(_r),Ke=dl(_r,!0,16711680),Ke.position.set(18,.6,0),Ke.rotation.y=Math.PI/2,console.log("Kart initial position:",Ke.position),mn=Mm(Ke),Ei=pl(Ke,Tt),fl(),gn(),console.log("Game initialized:",{kart:Ke,controls:mn,physics:Ei}),Cm()}function fl(){He.aiKarts.forEach(t=>{_r.remove(t)}),He.aiKarts=[],ba=[];const i=[65280,255,16776960],e=[{x:18,y:.6,z:3},{x:18,y:.6,z:-3},{x:16,y:.6,z:0}];for(let t=0;t<3;t++){const r=dl(_r,!1,i[t]);r.position.copy(e[t]),r.rotation.y=Math.PI/2,r.userData.ai={targetPoint:0,steeringFactor:.8+Math.random()*.4,speedFactor:.7+Math.random()*.3,updateTarget:function(a){this.targetPoint=(this.targetPoint+1)%a.length},getTargetPosition:function(a){return a[this.targetPoint].position.clone()}};const n=pl(r,Tt);ba.push(n),He.aiKarts.push(r)}console.log("Created AI karts:",He.aiKarts)}function Rm(){if(!Tt||!Tt.userData||!Tt.userData.checkpoints)return;const i=Tt.userData.checkpoints.children;He.aiKarts.forEach((e,t)=>{if(!e.visible)return;const r=e.userData.ai.getTargetPosition(i),n=new C().subVectors(r,e.position).normalize(),a=new C(0,0,-1).applyQuaternion(e.quaternion),o=a.angleTo(n),s=new C().crossVectors(a,n),l=Math.sign(s.y),c=Math.min(o,.05)*l*e.userData.ai.steeringFactor;e.rotation.y+=c,e.userData.acceleration=.08*e.userData.ai.speedFactor,e.position.distanceTo(r)<5&&e.userData.ai.updateTarget(i),ba[t].update()})}function Cm(){const i=document.createElement("div");i.style.position="absolute",i.style.bottom="20px",i.style.left="20px",i.style.zIndex="1000";const e=document.createElement("button");e.textContent="Move Forward",e.style.padding="10px",e.style.marginRight="10px",e.addEventListener("click",()=>{console.log("Manual forward movement triggered"),He.isPlaying||Ci(),Ke.userData.acceleration=.1,Ke.userData.speed=1});const t=document.createElement("button");t.textContent="Move Backward",t.style.padding="10px",t.addEventListener("click",()=>{console.log("Manual backward movement triggered"),He.isPlaying||Ci(),Ke.userData.acceleration=-.1,Ke.userData.speed=-1});const r=document.createElement("button");r.textContent="Turn Left",r.style.padding="10px",r.style.marginRight="10px",r.style.marginTop="10px",r.addEventListener("click",()=>{console.log("Manual left turn triggered"),Ke.rotation.y+=.1});const n=document.createElement("button");n.textContent="Turn Right",n.style.padding="10px",n.style.marginTop="10px",n.addEventListener("click",()=>{console.log("Manual right turn triggered"),Ke.rotation.y-=.1}),i.appendChild(e),i.appendChild(t),i.appendChild(document.createElement("br")),i.appendChild(r),i.appendChild(n),document.body.appendChild(i)}function Ci(){console.log("Starting game..."),He.isPlaying=!0,He.currentLap=1,He.startTime=performance.now(),He.raceStartTime=performance.now(),He.lapTimes=[],He.countdownComplete=!1,Ke.position.set(18,.6,0),Ke.rotation.y=Math.PI/2,Ke.userData.speed=0,Ke.userData.acceleration=0,fl(),Tt&&Tt.userData&&Tt.userData.checkpointStates&&Tt.userData.checkpointStates.fill(!1),Ta.style.display="none",gn(),window.addEventListener("keydown",i=>{console.log("Key pressed:",i.code),i.code==="KeyW"&&console.log("W key pressed - Control state should update")}),Pm()}function Pm(){const i=document.createElement("div");i.style.position="absolute",i.style.top="50%",i.style.left="50%",i.style.transform="translate(-50%, -50%)",i.style.fontSize="100px",i.style.color="white",i.style.textShadow="2px 2px 4px rgba(0, 0, 0, 0.5)",i.style.zIndex="1000",i.style.fontFamily="Arial, sans-serif",i.style.fontWeight="bold",i.id="countdown",document.body.appendChild(i);let e=3;i.textContent=e;const t=setInterval(()=>{e--,e>0?i.textContent=e:e===0?(i.textContent="GO!",i.style.color="#00ff00",He.countdownComplete=!0,mn.enableControls(),Lm()):(clearInterval(t),document.body.removeChild(i))},1e3)}function Lm(){const i=new(window.AudioContext||window.webkitAudioContext),e=i.createOscillator(),t=i.createGain();e.type="square",e.frequency.value=440,t.gain.value=.1,e.connect(t),t.connect(i.destination),e.start(),e.frequency.exponentialRampToValueAtTime(880,i.currentTime+.5),setTimeout(()=>{e.stop()},500)}function gn(){Em.textContent=`Speed: ${Math.round(He.speed*3.6)} km/h`,Tm.textContent=`Lap: ${He.currentLap}/${He.totalLaps}`,He.isPlaying&&Math.abs(He.speed)>.01&&console.log("Current speed:",He.speed)}function Dm(){ti.aspect=window.innerWidth/window.innerHeight,ti.updateProjectionMatrix(),hi.setSize(window.innerWidth,window.innerHeight)}function ml(){if(requestAnimationFrame(ml),He.isPlaying){He.countdownComplete&&(mn.update(),Ei.update(),Rm());const i=new C(0,5,10);if(new C(0,0,-1).applyQuaternion(Ke.quaternion),i.applyQuaternion(Ke.quaternion),ti.position.copy(Ke.position).add(i),ti.lookAt(Ke.position),He.speed=Ei.getSpeed(),Ei.checkLapComplete()){const e=performance.now()-He.startTime;He.lapTimes.push(e),He.startTime=performance.now(),Nm(),Im(He.currentLap),He.currentLap++,He.currentLap>He.totalLaps&&(He.totalRaceTime=performance.now()-He.raceStartTime,Om()),gn()}Um(),gn()}hi.render(_r,ti)}function Um(){Tt&&Tt.userData&&Tt.userData.powerups&&Tt.userData.powerups.children.forEach(i=>{i.userData&&i.userData.update&&i.userData.update()})}function Nm(){const i=new(window.AudioContext||window.webkitAudioContext),e=i.createOscillator(),t=i.createGain();e.type="sine",e.frequency.value=880,t.gain.value=.1,e.connect(t),t.connect(i.destination),e.start(),setTimeout(()=>{e.stop()},300)}function Im(i){const e=document.createElement("div");e.style.position="absolute",e.style.top="30%",e.style.left="50%",e.style.transform="translate(-50%, -50%)",e.style.fontSize="40px",e.style.color="white",e.style.textShadow="2px 2px 4px rgba(0, 0, 0, 0.5)",e.style.zIndex="1000",e.style.fontFamily="Arial, sans-serif",e.style.fontWeight="bold",e.style.backgroundColor="rgba(0, 0, 0, 0.5)",e.style.padding="10px 20px",e.style.borderRadius="10px",e.textContent=`Lap ${i} Complete!`,document.body.appendChild(e),setTimeout(()=>{document.body.removeChild(e)},2e3)}function Om(){He.isPlaying=!1;const i=He.lapTimes.map((t,r)=>`<p>Lap ${r+1}: ${(t/1e3).toFixed(2)}s</p>`).join(""),e=(He.totalRaceTime/1e3).toFixed(2);Ta.style.display="block",Ta.innerHTML=`
        <h1>Race Complete!</h1>
        <p>Lap Times:</p>
        ${i}
        <p>Total Time: ${e}s</p>
        <button id="restart-button">Restart Race</button>
    `,document.getElementById("restart-button").addEventListener("click",Ci),Fm()}function Fm(){const i=new(window.AudioContext||window.webkitAudioContext),e=(r,n,a)=>{const o=i.createOscillator(),s=i.createGain();o.type="sine",o.frequency.value=r,s.gain.value=.1,o.connect(s),s.connect(i.destination),o.start(n),o.stop(n+a)},t=i.currentTime;e(523.25,t,.2),e(659.25,t+.2,.2),e(783.99,t+.4,.2),e(1046.5,t+.6,.4)}window.addEventListener("resize",Dm);bm.addEventListener("click",Ci);Am();ml();window.testKartMovement=function(){console.log("Testing kart movement..."),He.isPlaying||(console.log("Game is not playing. Starting game..."),Ci()),console.log("Setting kart acceleration manually"),Ke.userData.acceleration=.1,Ke.userData.speed=1,console.log("Current kart data:",{position:Ke.position,rotation:Ke.rotation,userData:Ke.userData})};
